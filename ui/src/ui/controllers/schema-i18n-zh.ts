...
export const ZH_CN_MAP: SchemaTranslationMap = {
  ...
  "commands.ownerAllowFrom": { label: "命令拥有者" },
  "commands.ownerDisplay": { label: "拥有者 ID 显示" },
  "commands.ownerDisplaySecret": { label: "拥有者 ID 哈希密钥" },
  "commands.allowFrom": { label: "命令提升访问规则" },

  // ── Messages ──
  messages: { label: "消息", help: "消息处理和路由设置。" },
  "messages.messagePrefix": { label: "入站消息前缀" },
  "messages.responsePrefix": { label: "出站响应前缀" },
  "messages.groupChat": { label: "群聊规则" },
  "messages.groupChat.mentionPatterns": { label: "群聊提及模式" },
  "messages.groupChat.historyLimit": { label: "群聊历史限制" },
  "messages.queue": { label: "入站队列" },
  "messages.queue.mode": { label: "队列模式" },
  "messages.queue.byChannel": { label: "按渠道队列模式" },
  "messages.queue.debounceMs": { label: "队列防抖（毫秒）" },
  "messages.queue.debounceMsByChannel": { label: "按渠道队列防抖（毫秒）" },
  "messages.queue.cap": { label: "队列容量" },
  "messages.queue.drop": { label: "队列丢弃策略" },
  "messages.inbound": { label: "入站防抖" },
  "messages.inbound.debounceMs": { label: "入站消息防抖（毫秒）" },
  "messages.inbound.byChannel": { label: "按渠道入站防抖（毫秒）" },
  "messages.suppressToolErrors": { label: "抑制工具错误警告" },
  "messages.ackReaction": { label: "确认反应表情" },
  "messages.ackReactionScope": { label: "确认反应范围" },
  "messages.removeAckAfterReply": { label: "回复后移除确认反应" },
  "messages.statusReactions": { label: "状态反应" },
  "messages.statusReactions.enabled": { label: "启用状态反应" },
  "messages.statusReactions.emojis": { label: "状态反应表情" },
  "messages.statusReactions.timing": { label: "状态反应时间" },
  "messages.tts": { label: "消息文本转语音" },

  // ── Channels ──
  channels: { label: "渠道", help: "消息渠道配置（Telegram、Discord、Slack 等）。" },
  "channels.defaults": { label: "渠道默认值" },
  "channels.defaults.groupPolicy": { label: "默认群组策略" },
  "channels.defaults.heartbeat": { label: "默认心跳可见性" },
  "channels.defaults.heartbeat.showOk": { label: "心跳显示正常" },
  "channels.defaults.heartbeat.showAlerts": { label: "心跳显示警告" },
  "channels.defaults.heartbeat.useIndicator": { label: "心跳使用指示器" },
  "channels.whatsapp": { label: "WhatsApp" },
  "channels.telegram": { label: "Telegram" },
  "channels.telegram.botToken": { label: "Telegram Bot Token" },
  "channels.telegram.dmPolicy": { label: "Telegram 私信策略" },
  "channels.telegram.configWrites": { label: "Telegram 配置写入" },
  "channels.telegram.commands.native": { label: "Telegram 原生命令" },
  "channels.telegram.commands.nativeSkills": { label: "Telegram 原生技能命令" },
  "channels.telegram.streaming": { label: "Telegram 流式模式" },
  ...
  "channels.modelByChannel": { label: "渠道模型覆盖" },
  ...
  "bindings[].agentId": { label: "绑定Agent ID" },
  "bindings[].match": { label: "绑定匹配规则" },
  "bindings[].match.channel": { label: "绑定渠道" },
  "bindings[].match.accountId": { label: "绑定账号 ID" },
  "bindings[].match.peer": { label: "绑定对等匹配" },
  "bindings[].match.peer.kind": { label: "绑定对等类型" },
  "bindings[].match.peer.id": { label: "绑定对等 ID" },
  "bindings[].match.guildId": { label: "绑定公会 ID" },
  "bindings[].match.teamId": { label: "绑定团队 ID" },
  "bindings[].match.roles": { label: "绑定角色" },

  // ── Cron ──
  cron: { label: "定时任务", help: "定时任务引擎配置，包括启用、存储、并发限制和自动重试。" },
  "cron.enabled": { label: "启用定时任务" },
  "cron.store": { label: "定时任务存储路径" },
  "cron.maxConcurrentRuns": { label: "定时任务最大并发运行" },
  "cron.retry": { label: "定时任务重试策略" },
  "cron.retry.maxAttempts": { label: "定时任务重试最大次数" },
  "cron.retry.backoffMs": { label: "定时任务重试退避（毫秒）" },
  "cron.retry.retryOn": { label: "定时任务重试错误类型" },
  "cron.webhook": { label: "定时任务旧版 Webhook（已弃用）" },
  "cron.webhookToken": { label: "定时任务 Webhook Bearer Token" },
  "cron.sessionRetention": { label: "定时任务会话保留" },
  "cron.runLog": { label: "定时任务运行日志清理" },
  "cron.runLog.maxBytes": { label: "定时任务运行日志最大字节数" },
  "cron.runLog.keepLines": { label: "定时任务运行日志保留行数" },

  // ── Hooks ──
  hooks: { label: "钩子", help: "Webhook 和事件钩子。" },
  "hooks.enabled": { label: "启用钩子" },
  "hooks.path": { label: "钩子端点路径" },
  "hooks.token": { label: "钩子认证令牌" },
  "hooks.defaultSessionKey": { label: "钩子默认会话键" },
  "hooks.allowRequestSessionKey": { label: "钩子允许请求会话键" },
  "hooks.allowedSessionKeyPrefixes": { label: "钩子允许的会话键前缀" },
  "hooks.allowedAgentIds": { label: "钩子允许的Agent ID" },
  "hooks.maxBodyBytes": { label: "钩子最大请求体字节数" },
  "hooks.presets": { label: "钩子预设" },
  "hooks.transformsDir": { label: "钩子转换目录" },
  "hooks.mappings": { label: "钩子映射" },
  "hooks.gmail": { label: "Gmail 钩子" },
  "hooks.internal": { label: "内部钩子" },
  "hooks.internal.enabled": { label: "启用内部钩子" },

  // ── Plugins ──
  plugins: { label: "插件", help: "插件管理和扩展。" },
  "plugins.enabled": { label: "启用插件" },
  "plugins.allow": { label: "插件白名单" },
  "plugins.deny": { label: "插件黑名单" },
  "plugins.load": { label: "插件加载器" },
  "plugins.load.paths": { label: "插件加载路径" },
  "plugins.slots": { label: "插件槽位" },
  "plugins.slots.memory": { label: "记忆插件" },
  "plugins.entries": { label: "插件条目" },
  "plugins.entries.*.enabled": { label: "启用插件" },
  "plugins.entries.*.apiKey": { label: "插件 API 密钥" },
  "plugins.entries.*.env": { label: "插件环境变量" },
  "plugins.entries.*.config": { label: "插件配置" },
  "plugins.installs": { label: "插件安装记录" },

  // ── Other ──
  nodeHost: { label: "节点主机", help: "节点主机设置，控制连接到中央网关的远程节点行为和能力。" },
  "nodeHost.browserProxy": { label: "节点浏览器代理" },
  "nodeHost.browserProxy.enabled": { label: "启用节点浏览器代理" },
  "nodeHost.browserProxy.allowProfiles": { label: "节点浏览器代理允许的配置文件" },
  media: { label: "媒体", help: "媒体处理控制。" },
  "media.preserveFilenames": { label: "保留媒体文件名" },
  audio: { label: "音频", help: "音频输入/输出设置。" },
  "audio.transcription": { label: "音频转录" },
  "audio.transcription.command": { label: "音频转录命令" },
  "audio.transcription.timeoutSeconds": { label: "音频转录超时（秒）" },
  broadcast: { label: "广播", help: "广播和通知设置。" },
  "broadcast.strategy": { label: "广播策略" },
  "broadcast.*": { label: "广播目标列表" },
  "skills.load.watch": { label: "监视技能" },
  "skills.load.watchDebounceMs": { label: "技能监视防抖（毫秒）" },
  ui: { label: "界面", help: "用户界面偏好设置。" },
  "ui.seamColor": { label: "强调色" },
  "ui.assistant": { label: "助手外观" },
  "ui.assistant.name": { label: "助手名称" },
  "ui.assistant.avatar": { label: "助手头像" },
  acp: { label: "ACP", help: "ACP（Agent通信协议）会话管理设置。" },
  "acp.enabled": { label: "启用 ACP" },
  "acp.dispatch.enabled": { label: "启用 ACP 调度" },
  "acp.backend": { label: "ACP 后端" },
  "acp.defaultAgent": { label: "ACP 默认Agent" },
  "acp.allowedAgents": { label: "ACP 允许的Agent" },
  "acp.maxConcurrentSessions": { label: "ACP 最大并发会话" },
  "acp.stream": { label: "ACP 流" },
  "acp.runtime.ttlMinutes": { label: "ACP 运行时 TTL（分钟）" },
  "acp.runtime.installCommand": { label: "ACP 运行时安装命令" },
  web: { label: "Web 渠道", help: "Web 服务器和 API 设置。" },
  "web.enabled": { label: "启用 Web 渠道" },
  "web.heartbeatSeconds": { label: "Web 渠道心跳间隔（秒）" },
  discovery: { label: "发现", help: "服务发现和网络设置。" },
  "discovery.wideArea": { label: "广域发现" },
  "discovery.wideArea.enabled": { label: "启用广域发现" },
  "discovery.mdns": { label: "mDNS 发现" },
  "discovery.mdns.mode": { label: "mDNS 发现模式" },
  canvasHost: { label: "Canvas 主机", help: "Canvas 渲染和显示设置。" },
  "canvasHost.enabled": { label: "启用 Canvas 主机" },
  "canvasHost.root": { label: "Canvas 主机根目录" },
  "canvasHost.port": { label: "Canvas 主机端口" },
  "canvasHost.liveReload": { label: "Canvas 主机实时重载" },
  talk: { label: "语音", help: "语音和语音合成设置。" },
  "talk.voiceId": { label: "语音 ID" },
  "talk.voiceAliases": { label: "语音别名" },
  "talk.modelId": { label: "语音模型 ID" },
  "talk.outputFormat": { label: "语音输出格式" },
  "talk.interruptOnSpeech": { label: "语音打断" },
  "talk.provider": { label: "语音提供商" },
  "talk.providers": { label: "语音提供商设置" },
  "talk.apiKey": { label: "语音 API 密钥" },
  ...
  "acp.stream.coalesceIdleMs": { label: "ACP 流空闲合并（毫秒）" },
  "acp.stream.maxChunkChars": { label: "ACP 流最大块字符数" },
  "acp.stream.repeatSuppression": { label: "ACP 流重复抑制" },
  "acp.stream.deliveryMode": { label: "ACP 流传输模式" },
  "acp.stream.hiddenBoundarySeparator": { label: "ACP 流隐藏边界分隔符" },
  "acp.stream.maxOutputChars": { label: "ACP 流最大输出字符数" },
  "acp.stream.maxSessionUpdateChars": { label: "ACP 流最大会话更新字符数" },
  "acp.stream.tagVisibility": { label: "ACP 流标签可见性" },
  ...
  "hooks.mappings[].id": { label: "钩子映射 ID" },
  "hooks.mappings[].match": { label: "钩子映射匹配" },
  "hooks.mappings[].match.path": { label: "钩子映射匹配路径" },
  "hooks.mappings[].match.source": { label: "钩子映射匹配源" },
  "hooks.mappings[].action": { label: "钩子映射操作" },
  "hooks.mappings[].wakeMode": { label: "钩子映射唤醒模式" },
  "hooks.mappings[].name": { label: "钩子映射名称" },
  "hooks.mappings[].agentId": { label: "钩子映射Agent ID" },
  "hooks.mappings[].sessionKey": { label: "钩子映射会话键" },
  "hooks.mappings[].messageTemplate": { label: "钩子映射消息模板" },
  "hooks.mappings[].textTemplate": { label: "钩子映射文本模板" },
  "hooks.mappings[].deliver": { label: "钩子映射投递回复" },
  "hooks.mappings[].allowUnsafeExternalContent": { label: "钩子映射允许不安全外部内容" },
  "hooks.mappings[].channel": { label: "钩子映射投递渠道" },
  "hooks.mappings[].to": { label: "钩子映射投递目标" },
  "hooks.mappings[].model": { label: "钩子映射模型覆盖" },
  "hooks.mappings[].thinking": { label: "钩子映射思考覆盖" },
  "hooks.mappings[].timeoutSeconds": { label: "钩子映射超时（秒）" },
  "hooks.mappings[].transform": { label: "钩子映射转换" },
  "hooks.mappings[].transform.module": { label: "钩子转换模块" },
  "hooks.mappings[].transform.export": { label: "钩子转换导出" },
  "hooks.gmail.account": { label: "Gmail 钩子账号" },
  "hooks.gmail.label": { label: "Gmail 钩子标签" },
  "hooks.gmail.topic": { label: "Gmail 钩子 Pub/Sub 主题" },
  "hooks.gmail.subscription": { label: "Gmail 钩子订阅" },
  "hooks.gmail.pushToken": { label: "Gmail 钩子推送令牌" },
  "hooks.gmail.hookUrl": { label: "Gmail 钩子回调 URL" },
  "hooks.gmail.includeBody": { label: "Gmail 钩子包含正文" },
  "hooks.gmail.maxBytes": { label: "Gmail 钩子最大请求体字节数" },
  "hooks.gmail.renewEveryMinutes": { label: "Gmail 钩子续订间隔（分钟）" },
  "hooks.gmail.allowUnsafeExternalContent": { label: "Gmail 钩子允许不安全外部内容" },
  "hooks.gmail.serve": { label: "Gmail 钩子本地服务器" },
  "hooks.gmail.serve.bind": { label: "Gmail 钩子服务器绑定地址" },
  "hooks.gmail.serve.port": { label: "Gmail 钩子服务器端口" },
  "hooks.gmail.serve.path": { label: "Gmail 钩子服务器路径" },
  "hooks.gmail.tailscale": { label: "Gmail 钩子 Tailscale" },
  "hooks.gmail.tailscale.mode": { label: "Gmail 钩子 Tailscale 模式" },
  "hooks.gmail.tailscale.path": { label: "Gmail 钩子 Tailscale 路径" },
  "hooks.gmail.tailscale.target": { label: "Gmail 钩子 Tailscale 目标" },
  "hooks.gmail.model": { label: "Gmail 钩子模型覆盖" },
  "hooks.gmail.thinking": { label: "Gmail 钩子思考覆盖" },
  "hooks.internal.handlers": { label: "内部钩子处理器" },
  "hooks.internal.handlers[].event": { label: "内部钩子事件" },
  "hooks.internal.handlers[].module": { label: "内部钩子模块" },
  "hooks.internal.handlers[].export": { label: "内部钩子导出" },
  "hooks.internal.entries": { label: "内部钩子条目" },
  "hooks.internal.load": { label: "内部钩子加载器" },
  "hooks.internal.load.extraDirs": { label: "内部钩子额外目录" },
  "hooks.internal.installs": { label: "内部钩子安装记录" },
  "web.reconnect": { label: "Web 渠道重连策略" },
  "web.reconnect.initialMs": { label: "Web 重连初始延迟（毫秒）" },
  "web.reconnect.maxMs": { label: "Web 重连最大延迟（毫秒）" },
  "web.reconnect.factor": { label: "Web 重连退避因子" },
  "web.reconnect.jitter": { label: "Web 重连抖动" },
  "web.reconnect.maxAttempts": { label: "Web 重连最大尝试次数" },
  "talk.providers.*.voiceId": { label: "语音提供商语音 ID" },
  "talk.providers.*.voiceAliases": { label: "语音提供商语音别名" },
  "talk.providers.*.modelId": { label: "语音提供商模型 ID" },
  "talk.providers.*.outputFormat": { label: "语音提供商输出格式" },
  "talk.providers.*.apiKey": { label: "语音提供商 API 密钥" },
  ...
  "channels.telegram.network.autoSelectFamily": { label: "Telegram 自动选择地址族" },
  ...
  "channels.whatsapp.selfChatMode": { label: "WhatsApp 自用手机模式" },
  "channels.whatsapp.debounceMs": { label: "WhatsApp 消息防抖（毫秒）" },
  "channels.whatsapp.configWrites": { label: "WhatsApp 配置写入" },
  "channels.signal.dmPolicy": { label: "Signal 私信策略" },
  "channels.signal.configWrites": { label: "Signal 配置写入" },
  "channels.imessage.dmPolicy": { label: "iMessage 私信策略" },
  "channels.imessage.configWrites": { label: "iMessage 配置写入" },
  "channels.bluebubbles.dmPolicy": { label: "BlueBubbles 私信策略" },
  "channels.msteams.configWrites": { label: "MS Teams 配置写入" },
  "channels.discord.dmPolicy": { label: "Discord 私信策略" },
  "channels.discord.dm.policy": { label: "Discord 私信策略" },
  "channels.discord.configWrites": { label: "Discord 配置写入" },
  "channels.discord.proxy": { label: "Discord 代理 URL" },
  "channels.discord.commands.native": { label: "Discord 原生命令" },
  "channels.discord.commands.nativeSkills": { label: "Discord 原生技能命令" },
  "channels.discord.streaming": { label: "Discord 流式模式" },
  "channels.discord.streamMode": { label: "Discord 流式模式（旧版）" },
  "channels.discord.draftChunk.minChars": { label: "Discord 草稿块最小字符数" },
  "channels.discord.draftChunk.maxChars": { label: "Discord 草稿块最大字符数" },
  "channels.discord.draftChunk.breakPreference": { label: "Discord 草稿块断行偏好" },
  ...
  "channels.discord.maxLinesPerMessage": { label: "Discord 每条消息最大行数" },
  "channels.discord.eventQueue.listenerTimeout": { label: "Discord 事件队列监听超时（毫秒）" },
  "channels.discord.eventQueue.maxQueueSize": { label: "Discord 事件队列最大大小" },
  "channels.discord.eventQueue.maxConcurrency": { label: "Discord 事件队列最大并发" },
  "channels.discord.threadBindings.enabled": { label: "Discord 线程绑定启用" },
  "channels.discord.threadBindings.idleHours": { label: "Discord 线程绑定空闲超时（小时）" },
  "channels.discord.threadBindings.maxAgeHours": { label: "Discord 线程绑定最大时长（小时）" },
  "channels.discord.threadBindings.spawnSubagentSessions": { label: "Discord 线程绑定子Agent派生" },
  "channels.discord.threadBindings.spawnAcpSessions": { label: "Discord 线程绑定 ACP 派生" },
  "channels.discord.ui.components.accentColor": { label: "Discord 组件强调色" },
  "channels.discord.intents.presence": { label: "Discord 存在状态意图" },
  "channels.discord.intents.guildMembers": { label: "Discord 公会成员意图" },
  "channels.discord.voice.enabled": { label: "Discord 语音启用" },
  "channels.discord.voice.autoJoin": { label: "Discord 语音自动加入" },
  "channels.discord.voice.daveEncryption": { label: "Discord 语音 DAVE 加密" },
  "channels.discord.voice.decryptionFailureTolerance": { label: "Discord 语音解密失败容错" },
  "channels.discord.voice.tts": { label: "Discord 语音文本转语音" },
  "channels.discord.pluralkit.enabled": { label: "Discord PluralKit 启用" },
  "channels.discord.pluralkit.token": { label: "Discord PluralKit 令牌" },
  "channels.discord.activity": { label: "Discord 存在状态活动" },
  "channels.discord.status": { label: "Discord 存在状态" },
  "channels.discord.activityType": { label: "Discord 存在状态活动类型" },
  "channels.discord.activityUrl": { label: "Discord 存在状态活动 URL" },
  "channels.slack.dm.policy": { label: "Slack 私信策略" },
  "channels.slack.dmPolicy": { label: "Slack 私信策略" },
  "channels.slack.configWrites": { label: "Slack 配置写入" },
  "channels.slack.commands.native": { label: "Slack 原生命令" },
  "channels.slack.commands.nativeSkills": { label: "Slack 原生技能命令" },
  "channels.slack.allowBots": { label: "Slack 允许机器人消息" },
  "channels.discord.token": { label: "Discord Bot 令牌" },
  "channels.slack.botToken": { label: "Slack Bot 令牌" },
  ...
  "channels.slack.streaming": { label: "Slack 流式模式" },
  "channels.slack.nativeStreaming": { label: "Slack 原生流式" },
  "channels.slack.streamMode": { label: "Slack 流式模式（旧版）" },
  "channels.slack.thread.historyScope": { label: "Slack 线程历史范围" },
  "channels.slack.thread.inheritParent": { label: "Slack 线程父继承" },
  "channels.slack.thread.initialHistoryLimit": { label: "Slack 线程初始历史限制" },
  "channels.mattermost.botToken": { label: "Mattermost Bot 令牌" },
  "channels.mattermost.baseUrl": { label: "Mattermost 基础 URL" },
  "channels.mattermost.configWrites": { label: "Mattermost 配置写入" },
  "channels.mattermost.chatmode": { label: "Mattermost 聊天模式" },
  "channels.mattermost.oncharPrefixes": { label: "Mattermost 触发字符前缀" },
  ...
  "agents.list[].skills": { label: "Agent技能过滤" },
  "agents.list[].identity.avatar": { label: "Agent头像" },
  "agents.list[].heartbeat.suppressToolErrorWarnings": { label: "Agent心跳抑制工具错误警告" },
  "agents.list[].sandbox.browser.network": { label: "Agent沙盒浏览器网络" },
  "agents.list[].sandbox.browser.cdpSourceRange": { label: "Agent沙盒浏览器 CDP 源端口范围" },
  ...
  "plugins.installs.*.resolvedName": { label: "插件解析包名" },
  "plugins.installs.*.resolvedVersion": { label: "插件解析包版本" },
  "plugins.installs.*.resolvedSpec": { label: "插件解析包规格" },
  "plugins.installs.*.integrity": { label: "插件解析完整性" },
  "plugins.installs.*.shasum": { label: "插件解析 Shasum" },
  "plugins.installs.*.resolvedAt": { label: "插件解析时间" },
