    ...
    if (elapsed < COMPACTION_TOAST_DURATION_MS) {
      return html`
        <div class="compaction-indicator compaction-indicator--complete" role="status" aria-live="polite">
          ${icons.check} ${t("chatView.compacted")}
        </div>
      `;
    }
  }
  ...
  const thread = html`
    ...
    >
      ${
        props.loading
          ? html`
              <div class="muted">${t("chatView.loadingChat")}</div>
            `
          : nothing
      }
      ${repeat(
        ...
        props.queue.length
          ? html`
            <div class="chat-queue" role="status" aria-live="polite">
              <div class="chat-queue__title">${t("shared.queued")} (${props.queue.length})</div>
        ...
        <div class="chat-compose__row">
          ...
          <div class="chat-compose__actions">
            ...
            <button
              ...
              @click=${props.onSend}
            >
              ${isBusy ? t("chatView.queue") : t("chatView.send")}<kbd class="btn-kbd">↵</kbd>
            </button>
          </div>
        </div>
      </div>
