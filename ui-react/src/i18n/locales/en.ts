...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    clawhub: "Search and install skills from ClawHub marketplace.",
  ...
  channelsQuickAdd: {
    ...
    accountIdHint: "Letters, numbers, and underscores only",
    botName: "Bot Name",
    botNamePlaceholder: "Bot display name",
    botNameHint: "Display name, any language",
    botTokenHint: "From @BotFather, format: 123456:ABC-DEF...",
    appIdHint: "From Feishu console, format: cli_xxxx",
    feishuConsoleLink: "Open console →",
    appSecretHint: "From Feishu developer console",
    bindAgent: "Bind Agent",
    agentSelect: "Select Agent",
    newAgent: "— Create New Agent —",
    agentId: "Agent ID",
    agentIdHint: "Auto-synced with Account ID, ASCII only",
    agentName: "Agent Name",
    agentNamePlaceholder: "Display name",
    agentNameHint: "Display name, any language",
    agentModel: "Model",
  ...
  agentsConfig: {
    ...
    schemaUnavailable: "Unable to load Agent config schema",
    modified: "Modified",
    noChanges: "No changes",
    reload: "Reload",
    reloading: "Reloading…",
    ...
    defaultsBadge: "Global",
    defaultsDesc: "Shared defaults inherited by all agents",
    defaultsInherited: "Inherited by all agents",
    configItems: "{count} config items",
    drawerDefaultsTitle: "Agent Defaults",
    drawerDefaultsSub: "Shared defaults inherited by all agents. Click save after editing.",
    // Agent list
    ...
    // Agent drawer
    drawerAgentSub: "Edit agent configuration. Click save after changes.",
    config: "Config",
  },
  skillsView: {
    searchSkills: "Search skills",
  ...
  clawhub: {
    ...
    subtitle: "Search and install skills from the public skill registry.",
    searchPlaceholder: "Search skills (e.g. calendar, browser, git...)",
    search: "Search",
    install: "Install",
    openWebsite: "Open ClawHub",
    noResults: "No skills found for this query.",
    searchHint: "Search for skills or browse the latest additions.",
    installSuccess: "Skill installed successfully! Restart your session to use it.",
    installError: "Failed to install skill.",
    tokenTitle: "API Token",
    tokenHint: "Add a ClawHub token for 6x higher rate limits (120/min download).",
    tokenActive: "Active",
    tokenPlaceholder: "clh_...",
    tokenSaved: "Token saved to config.",
    tokenCleared: "Token removed from config.",
  },
  logsView: {
