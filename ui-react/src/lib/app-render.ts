      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${!state.onboarding
          ? html`<section class="content-header">
              <div>
                ${state.tab === "usage" || state.tab === "overview"
                  ? nothing
              ...
              <div class="page-meta">
                ${state.lastError
                  ? html`<div class="pill danger">${translateError(state.lastError)}</div>`
                  : nothing}
              ...
              ? html`
                  <div class="models-page">
                    ${renderModelsQuickAdd({
                      ...
                      onRemoveModel: (index) => {
                        const models = state.modelsQuickAddForm.models.filter(
                          (_, i) => i !== index,
                        );
                        state.modelsQuickAddForm = { ...state.modelsQuickAddForm, models };
                      },
