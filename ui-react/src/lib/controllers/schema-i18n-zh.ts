...
export const ZH_CN_MAP: SchemaTranslationMap = {
  ...
  "commands.native": {
    label: "原生命令",
    help: "启用时暴露内置命令（如 /help、/status 等），禁用则隐藏。",
  },
  "commands.nativeSkills": {
    label: "原生技能命令",
    help: "启用时暴露内置技能命令，如 /search、/web 等。",
  },
  "commands.text": { label: "文本命令", help: "自定义文本命令映射表，键为命令名，值为响应模板。" },
  "commands.bash": {
    label: "允许 Bash 聊天命令",
    help: "允许通过聊天执行 bash/shell 命令。启用有安全风险，仅在受信环境中使用。",
  },
  "commands.bashForegroundMs": {
    label: "Bash 前台窗口（毫秒）",
    help: "Bash 命令在前台等待完成的最大时间（毫秒），超时后转为后台执行。",
  },
  "commands.config": {
    label: "允许 /config",
    help: "启用 /config 命令，允许通过聊天查看和修改配置。",
  },
  "commands.debug": { label: "允许 /debug", help: "启用 /debug 命令，允许通过聊天访问调试信息。" },
  "commands.restart": { label: "允许重启", help: "启用 /restart 命令，允许通过聊天重启网关。" },
  "commands.useAccessGroups": {
    label: "使用访问组",
    help: "启用渠道级别的访问组门控，用于细粒度命令权限控制。",
  },
  "commands.ownerAllowFrom": {
    label: "命令拥有者",
    help: "指定命令拥有者的渠道 ID 列表，拥有者可执行所有提升命令。",
  },
  "commands.ownerDisplay": { label: "拥有者 ID 显示", help: "控制是否在状态输出中显示拥有者 ID。" },
  "commands.ownerDisplaySecret": {
    label: "拥有者 ID 哈希密钥",
    help: "用于对拥有者 ID 进行哈希处理的密钥，保护隐私。",
  },
  "commands.allowFrom": {
    label: "命令提升访问规则",
    help: "按命令名定义的提升访问规则，控制哪些用户可以执行特定命令。",
  },
  ...
  "messages.suppressToolErrors": {
    label: "抑制工具错误警告",
    help: "启用后工具执行错误不会在聊天中显示警告消息。",
  },
  "messages.ackReaction": {
    label: "确认反应表情",
    help: "收到消息后添加的确认反应表情（如 👀），设为空字符串禁用。",
  },
  "messages.ackReactionScope": {
    label: "确认反应范围",
    help: "确认反应的适用范围：所有消息、仅私信或仅群聊。",
  },
  "messages.removeAckAfterReply": {
    label: "回复后移除确认反应",
    help: "回复发送后自动移除确认反应表情。",
  },
  "messages.statusReactions": {
    label: "状态反应",
    help: "处理状态反应设置，在消息处理时显示动态状态表情。",
  },
  "messages.statusReactions.enabled": {
    label: "启用状态反应",
    help: "启用后处理消息时显示动态状态反应表情。",
  },
  "messages.statusReactions.emojis": {
    label: "状态反应表情",
    help: "按处理阶段显示的状态反应表情列表。",
  },
  ...
  "channels.telegram.botToken": {
    ...
    help: "Telegram Bot API 令牌，从 @BotFather 获取。",
  },
  "channels.telegram.dmPolicy": { label: "Telegram 私信策略", help: "Telegram 私信访问策略。" },
  "channels.telegram.configWrites": {
    label: "Telegram 配置写入",
    help: "控制是否允许通过 Telegram 修改配置。",
  },
  "channels.telegram.commands.native": {
    label: "Telegram 原生命令",
    help: "Telegram 中是否启用原生命令。",
  },
  "channels.telegram.commands.nativeSkills": {
    label: "Telegram 原生技能命令",
    help: "Telegram 中是否启用原生技能命令。",
  },
  "channels.telegram.streaming": {
    label: "Telegram 流式模式",
    help: "启用后 Telegram 消息会逐步流式输出。",
  },
  "channels.telegram.customCommands": {
    label: "Telegram 自定义命令",
    help: "Telegram 中的自定义斜杠命令列表。",
  },
  ...
  "channels.bluebubbles": {
    label: "BlueBubbles",
    help: "BlueBubbles 渠道配置，用于 iMessage 跨平台访问。",
  },
  ...
  "cron.webhook": {
    label: "定时任务旧版 Webhook（已弃用）",
    help: "定时任务旧版 Webhook（已弃用）。",
  },
  "cron.webhookToken": {
    label: "定时任务 Webhook Bearer Token",
    help: "定时任务 Webhook Bearer Token。",
  },
  ...
  "hooks.enabled": {
    label: "启用钩子",
    help: "启用钩子端点和映射执行管线，用于处理入站 Webhook 请求。",
  },
  "hooks.path": { label: "钩子端点路径", help: "钩子端点在网关控制服务器上使用的 HTTP 路径。" },
  "hooks.token": { label: "钩子认证令牌", help: "钩子入站请求校验的共享 Bearer 令牌。" },
  "hooks.defaultSessionKey": {
    label: "钩子默认会话键",
    help: "钩子请求未提供会话键时使用的默认会话键。",
  },
  "hooks.allowRequestSessionKey": {
    label: "钩子允许请求会话键",
    help: "允许调用方在钩子请求中提供会话键，支持调用方控制的会话路由。",
  },
  "hooks.allowedSessionKeyPrefixes": {
    label: "钩子允许的会话键前缀",
    help: "允许的会话键前缀白名单，防止任意会话键注入。",
  },
  "hooks.allowedAgentIds": {
    label: "钩子允许的Agent ID",
    help: "允许钩子映射目标的 Agent ID 白名单。",
  },
  "hooks.maxBodyBytes": {
    label: "钩子最大请求体字节数",
    help: "Webhook 请求体的最大字节数，超过则拒绝请求。",
  },
  "hooks.presets": {
    label: "钩子预设",
    help: "预定义的钩子配置包，加载时应用标准映射和行为默认值。",
  },
  "hooks.transformsDir": { label: "钩子转换目录", help: "包含钩子转换脚本模块的目录路径。" },
  "hooks.mappings": {
    label: "钩子映射",
    help: "钩子路由映射列表，将入站请求指向特定 Agent 和操作。",
  },
  "hooks.gmail": {
    label: "Gmail 钩子",
    help: "Gmail 集成钩子设置，通过 Google Pub/Sub 接收邮件通知。",
  },
  ...
  "nodeHost.browserProxy.allowProfiles": {
    label: "节点浏览器代理允许的配置文件",
    help: "允许代理使用的浏览器配置文件列表。",
  },
  media: { label: "媒体", help: "媒体处理控制。" },
  "media.preserveFilenames": {
    label: "保留媒体文件名",
    help: "启用后保留原始媒体文件名而不是生成随机名称。",
  },
  ...
  "hooks.gmail.maxBytes": {
    label: "Gmail 钩子最大请求体字节数",
    help: "Gmail 请求体的最大字节数。",
  },
  "hooks.gmail.renewEveryMinutes": {
    label: "Gmail 钩子续订间隔（分钟）",
    help: "Gmail watch 订阅的自动续订间隔。",
  },
  "hooks.gmail.allowUnsafeExternalContent": {
    label: "Gmail 钩子允许不安全外部内容",
    help: "允许传递未经消毒的邮件内容。",
  },
  "hooks.gmail.serve": {
    label: "Gmail 钩子本地服务器",
    help: "Gmail 钩子的本地 HTTP 服务器设置。",
  },
  "hooks.gmail.serve.bind": {
    label: "Gmail 钩子服务器绑定地址",
    help: "本地服务器绑定的网络地址。",
  },
  ...
  "hooks.gmail.tailscale": {
    label: "Gmail 钩子 Tailscale",
    help: "Gmail 钩子的 Tailscale 隧道设置。",
  },
  "hooks.gmail.tailscale.mode": {
    label: "Gmail 钩子 Tailscale 模式",
    help: "Tailscale 隧道模式。",
  },
  "hooks.gmail.tailscale.path": {
    label: "Gmail 钩子 Tailscale 路径",
    help: "Tailscale 回调路径。",
  },
  "hooks.gmail.tailscale.target": {
    label: "Gmail 钩子 Tailscale 目标",
    help: "Tailscale 隧道目标地址。",
  },
  ...
  "channels.telegram.retry.minDelayMs": {
    ...
    help: "Telegram 重试最小延迟（毫秒）。",
  },
  "channels.telegram.retry.maxDelayMs": {
    label: "Telegram 重试最大延迟（毫秒）",
    help: "Telegram 重试最大延迟（毫秒）。",
  },
  "channels.telegram.retry.jitter": { label: "Telegram 重试抖动", help: "Telegram 重试抖动。" },
  "channels.telegram.network.autoSelectFamily": {
    label: "Telegram 自动选择地址族",
    help: "Telegram 自动选择地址族。",
  },
  "channels.telegram.timeoutSeconds": {
    label: "Telegram API 超时（秒）",
    help: "Telegram API 超时（秒）。",
  },
  ...
  "channels.whatsapp.selfChatMode": {
    label: "WhatsApp 自用手机模式",
    help: "WhatsApp 自用手机模式。",
  },
  "channels.whatsapp.debounceMs": {
    label: "WhatsApp 消息防抖（毫秒）",
    help: "WhatsApp 消息防抖（毫秒）。",
  },
  ...
  "channels.bluebubbles.dmPolicy": {
    label: "BlueBubbles 私信策略",
    help: "BlueBubbles 私信策略。",
  },
  ...
  "channels.discord.commands.nativeSkills": {
    label: "Discord 原生技能命令",
    help: "Discord 原生技能命令。",
  },
  "channels.discord.streaming": { label: "Discord 流式模式", help: "Discord 流式模式。" },
  "channels.discord.streamMode": {
    label: "Discord 流式模式（旧版）",
    help: "Discord 流式模式（旧版）。",
  },
  "channels.discord.draftChunk.minChars": {
    label: "Discord 草稿块最小字符数",
    help: "Discord 草稿块最小字符数。",
  },
  "channels.discord.draftChunk.maxChars": {
    label: "Discord 草稿块最大字符数",
    help: "Discord 草稿块最大字符数。",
  },
  "channels.discord.draftChunk.breakPreference": {
    label: "Discord 草稿块断行偏好",
    help: "Discord 草稿块断行偏好。",
  },
  "channels.discord.retry.attempts": { label: "Discord 重试次数", help: "Discord 重试次数。" },
  "channels.discord.retry.minDelayMs": {
    label: "Discord 重试最小延迟（毫秒）",
    help: "Discord 重试最小延迟（毫秒）。",
  },
  "channels.discord.retry.maxDelayMs": {
    label: "Discord 重试最大延迟（毫秒）",
    help: "Discord 重试最大延迟（毫秒）。",
  },
  "channels.discord.retry.jitter": { label: "Discord 重试抖动", help: "Discord 重试抖动。" },
  "channels.discord.maxLinesPerMessage": {
    label: "Discord 每条消息最大行数",
    help: "Discord 每条消息最大行数。",
  },
  "channels.discord.eventQueue.listenerTimeout": {
    label: "Discord 事件队列监听超时（毫秒）",
    help: "Discord 事件队列监听超时（毫秒）。",
  },
  "channels.discord.eventQueue.maxQueueSize": {
    label: "Discord 事件队列最大大小",
    help: "Discord 事件队列最大大小。",
  },
  "channels.discord.eventQueue.maxConcurrency": {
    label: "Discord 事件队列最大并发",
    help: "Discord 事件队列最大并发。",
  },
  "channels.discord.threadBindings.enabled": {
    label: "Discord 线程绑定启用",
    help: "Discord 线程绑定启用。",
  },
  "channels.discord.threadBindings.idleHours": {
    label: "Discord 线程绑定空闲超时（小时）",
    help: "Discord 线程绑定空闲超时（小时）。",
  },
  "channels.discord.threadBindings.maxAgeHours": {
    label: "Discord 线程绑定最大时长（小时）",
    help: "Discord 线程绑定最大时长（小时）。",
  },
  "channels.discord.threadBindings.spawnSubagentSessions": {
    label: "Discord 线程绑定子Agent派生",
    help: "Discord 线程绑定子Agent派生。",
  },
  "channels.discord.threadBindings.spawnAcpSessions": {
    label: "Discord 线程绑定 ACP 派生",
    help: "Discord 线程绑定 ACP 派生。",
  },
  ...
  "channels.discord.intents.presence": {
    label: "Discord 存在状态意图",
    help: "Discord 存在状态意图。",
  },
  "channels.discord.intents.guildMembers": {
    label: "Discord 公会成员意图",
    help: "Discord 公会成员意图。",
  },
  ...
  "channels.discord.voice.daveEncryption": {
    ...
    help: "Discord 语音 DAVE 加密。",
  },
  "channels.discord.voice.decryptionFailureTolerance": {
    label: "Discord 语音解密失败容错",
    help: "Discord 语音解密失败容错。",
  },
  "channels.discord.voice.tts": {
    label: "Discord 语音文本转语音",
    help: "Discord 语音文本转语音。",
  },
  "channels.discord.pluralkit.enabled": {
    label: "Discord PluralKit 启用",
    help: "Discord PluralKit 启用。",
  },
  "channels.discord.pluralkit.token": {
    label: "Discord PluralKit 令牌",
    help: "Discord PluralKit 令牌。",
  },
  ...
  "channels.discord.activityType": {
    label: "Discord 存在状态活动类型",
    help: "Discord 存在状态活动类型。",
  },
  "channels.discord.activityUrl": {
    label: "Discord 存在状态活动 URL",
    help: "Discord 存在状态活动 URL。",
  },
  ...
  "channels.mattermost.configWrites": {
    label: "Mattermost 配置写入",
    help: "Mattermost 配置写入。",
  },
  "channels.mattermost.chatmode": { label: "Mattermost 聊天模式", help: "Mattermost 聊天模式。" },
  "channels.mattermost.oncharPrefixes": {
    label: "Mattermost 触发字符前缀",
    help: "Mattermost 触发字符前缀。",
  },
  "channels.mattermost.requireMention": {
    label: "Mattermost 需要@提及",
    help: "Mattermost 需要@提及。",
  },
  ...
  "agents.list[].heartbeat.suppressToolErrorWarnings": {
    label: "Agent心跳抑制工具错误警告",
    help: "Agent心跳抑制工具错误警告。",
  },
  ...
  "agents.list[].sandbox.browser.cdpSourceRange": {
    label: "Agent沙盒浏览器 CDP 源端口范围",
    help: "Agent沙盒浏览器 CDP 源端口范围。",
  },
