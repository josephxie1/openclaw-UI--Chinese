...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-D2eqGDrA.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-gyti7QOy.js";
import { t as WizardCancelledError } from "./prompts-CNzp9M83.js";
import { t as createClackPrompter } from "./clack-prompter-3l9KoDtA.js";
import { t as assertSupportedRuntime } from "./runtime-guard-JlKhn9Xx.js";
...
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CmgoyS2u.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Ci2Z4f7y.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BSQMJ-eF.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DucjJfYw.js").then((n) => n.i);
