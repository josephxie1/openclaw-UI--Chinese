...
import { t as CONFIG_PATH } from "./paths-B9jPXz5d.js";
import { L as colorize, R as isRich$1, x as shortenHomePath, z as theme } from "./utils-XeuG5BG2.js";
import { $n as findNormalizedProviderValue, Fn as upsertAuthProfile, Gn as resolveOpenClawAgentDir, Jr as resolveApiKeyForProvider, Kr as getCustomProviderApiKey, Mn as listProfilesForProvider, Pn as setAuthProfileOrder, Qn as buildModelAliasIndex, Qr as getShellEnvAppliedKeys, Rn as ensureAuthProfileStore, Wn as resolveAuthStorePathForDisplay, Xr as resolveEnvApiKey, Yr as resolveAwsSdkEnvVarName, bi as DEFAULT_PROVIDER, dr as resolveDefaultModelForAgent, j as loadConfig, n as resolveAuthProfileOrder, or as normalizeProviderId, pr as resolveModelRefFromString, rr as modelKey, rt as parseDurationMs, s as resolveProfileUnusableUntilForDisplay, sr as parseModelRef, ti as shouldEnableShellEnvFallback, ur as resolveConfiguredModelRef, xi as resolveAuthProfileDisplayLabel, yi as DEFAULT_MODEL } from "./auth-profiles-CZvcgpJo.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-a8AT_RWh.js";
import { r as resolveForwardCompatModel } from "./model-CJQJEjak.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DECvU61g.js";
import { Cn as resolveUsageProviderId, Sn as formatUsageWindowSummary, Tt as describeFailoverError, bn as loadProviderUsageSummary, nn as buildAuthHealthSummary, rn as formatRemainingShort, s as runEmbeddedPiAgent, tn as DEFAULT_OAUTH_WARN_MS, wn as maskApiKey } from "./subagent-registry-BEhIECVo.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BUjNRwj7.js";
import { t as ensureOpenClawModelsJson } from "./models-config-pDwBB9Bk.js";
import { n as loadModelCatalog } from "./model-catalog-B2D_BloA.js";
import { r as withProgressTotals } from "./progress-CoLN8zGu.js";
import { f as openUrl } from "./onboard-helpers-gyti7QOy.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BcyiLcfo.js";
import { t as createClackPrompter } from "./clack-prompter-3l9KoDtA.js";
import { t as renderTable } from "./table-CwwhM1rv.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-C9eKW_aW.js";
import { n as redactSecrets } from "./format-DkpmdVIr.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-CjDPn3ER.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CN7y4Eld.js";
import { n as logConfigUpdated } from "./logging-DV03yykq.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-C1ctajP2.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-CZvcgpJo.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-CZvcgpJo.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CJQJEjak.js").then((n) => n.t);
