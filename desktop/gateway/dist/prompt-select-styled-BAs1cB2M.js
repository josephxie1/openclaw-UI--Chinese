import { d as resolveIsNixMode, g as resolveStateDir, m as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, y as resolveRequiredHomeDir } from "./paths-B9jPXz5d.js";
import { p as defaultRuntime } from "./subsystem-D2eqGDrA.js";
import { H as getResolvedLoggerSettings, S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-XeuG5BG2.js";
import { r as isTruthyEnvValue$1 } from "./entry.js";
import { An as repairOAuthProfileIdMismatch, Ci as CODEX_CLI_PROFILE_ID, Hn as updateAuthProfileStoreWithLock, Jr as resolveApiKeyForProvider, L as writeConfigFile, N as readConfigFileSnapshot, Rn as ensureAuthProfileStore, Si as CLAUDE_CLI_PROFILE_ID, bi as DEFAULT_PROVIDER, er as getModelRefStatus, fr as resolveHooksGmailModel, l as resolveApiKeyForProfile, s as resolveProfileUnusableUntilForDisplay, ur as resolveConfiguredModelRef, yi as DEFAULT_MODEL } from "./auth-profiles-CZvcgpJo.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-a8AT_RWh.js";
import { w as parseAgentSessionKey } from "./session-key-Cuihcz_O.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-PXe5cw0N.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CSag7MO2.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dvz3Ec4l.js";
import { V as cleanStaleLockFiles, c as loadSessionStore, nt as resolveMainSessionKey, ot as formatSessionArchiveTimestamp, st as isPrimarySessionTranscriptFileName } from "./sessions-Bi0azzm9.js";
import { n as listChannelPlugins } from "./plugins-BzP494ZB.js";
import { _ as loadOpenClawPlugins, ir as resolveAgentSessionDirs, nn as buildAuthHealthSummary, rn as formatRemainingShort, tn as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-BEhIECVo.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BUjNRwj7.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-sYT50rpM.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BmOGX3t_.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-DTBpCi6a.js";
import { a as resolveGatewayAuth } from "./auth-B4wlyb-l.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-BwOg8fHr.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-Dz7xGF6Z.js";
...
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CTUY4pfE.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-DobOP4bl.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-CAW6eokW.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-gyti7QOy.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BcyiLcfo.js";
import { t as note$1 } from "./note-Bpomg9Vl.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D_svjtS4.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-xL5q-QSP.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Dgg-ogyc.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-BUXXkyXd.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BuXPDsCx.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-BgQkg50P.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DsU2-25q.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-B9kcs3XP.js";
import { r as healthCommand } from "./health-DucjJfYw.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DnxiZ3-i.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CzSKGcio.js";
import { t as runGatewayUpdate } from "./update-runner-DRLuJ_8M.js";
import { n as logConfigUpdated } from "./logging-DV03yykq.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-BPFVDJ5o.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CfOpcKpz.js";
import { t as formatHealthCheckFailure } from "./health-format-D8ToCOCd.js";
import { n as doctorShellCompletion } from "./doctor-completion-bm_BNLIQ.js";
