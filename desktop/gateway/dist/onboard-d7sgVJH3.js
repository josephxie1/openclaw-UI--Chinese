...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-Cg_UWVEG.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-D6FHY_pZ.js";
import { t as WizardCancelledError } from "./prompts-BkPGYLNt.js";
import { t as createClackPrompter } from "./clack-prompter-Cfiyq5fc.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DzsNMb_E.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CeI4hRxg.js";
import { t as runOnboardingWizard } from "./onboarding-DaYazgVq.js";
import { n as logConfigUpdated } from "./logging-Ck3u149k.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-0ooSwFCP.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CkjIHzS0.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Mc_lFX7M.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BUYxO-3Z.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-0WSo_dPP.js");
