import { d as resolveIsNixMode, g as resolveStateDir, m as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, y as resolveRequiredHomeDir } from "./paths-DPETYfXn.js";
import { p as defaultRuntime } from "./subsystem-Cg_UWVEG.js";
import { H as getResolvedLoggerSettings, S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-CfiuWRBq.js";
import { r as isTruthyEnvValue$1 } from "./entry.js";
import { Ai as DEFAULT_MODEL, Kn as ensureAuthProfileStore, Ln as repairOAuthProfileIdMismatch, Ni as CLAUDE_CLI_PROFILE_ID, P as readConfigFileSnapshot, Pi as CODEX_CLI_PROFILE_ID, Qn as updateAuthProfileStoreWithLock, R as writeConfigFile, Sr as resolveHooksGmailModel, br as resolveConfiguredModelRef, c as resolveProfileUnusableUntilForDisplay, ii as resolveApiKeyForProvider, ji as DEFAULT_PROVIDER, u as resolveApiKeyForProfile, ur as getModelRefStatus } from "./auth-profiles-BghqkBM8.js";
import { t as formatCliCommand } from "./command-format-D-E6F1gN.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-CIzpI5xh.js";
import { w as parseAgentSessionKey } from "./session-key-Bbgq13tJ.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-3Za7U6qY.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BAZSkTa2.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dl_mVGTt.js";
import { G as cleanStaleLockFiles, St as isPrimarySessionTranscriptFileName, ht as resolveMainSessionKey, u as loadSessionStore, xt as formatSessionArchiveTimestamp } from "./sessions-DVvS5iwr.js";
import { n as listChannelPlugins } from "./plugins-Bxiq3d8j.js";
import { D as loadOpenClawPlugins, dn as DEFAULT_OAUTH_WARN_MS, fn as buildAuthHealthSummary, mr as resolveAgentSessionDirs, pn as formatRemainingShort } from "./subagent-registry-BYIe-M9p.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CVD1Nvmu.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BMs9hz0g.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-D_wo0Sl1.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-DTxaN4ta.js";
import { a as resolveGatewayAuth } from "./auth-DhIxsXk7.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-B6VfKv4T.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-D_gNNCvC.js";
import { n as resolveMemorySearchConfig } from "./manager-CkKrVtnJ.js";
import { n as loadModelCatalog } from "./model-catalog-CW4skMS-.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CZ2QuH-y.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-h94KMUAM.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DHKe3cuX.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-IFNeulFC.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D01Z207U.js";
import { t as note$1 } from "./note-CztWsdZ6.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CCkvxSvf.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-Dk8BToL9.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CeI4hRxg.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-BPIlmdfK.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-C4_4PrdB.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-D-OrV2JJ.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-Ca1e5iIs.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-BfXCvZ2j.js";
import { r as healthCommand } from "./health-Cgxhr072.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-GGFclzNd.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CpsEsWss.js";
import { t as runGatewayUpdate } from "./update-runner-Dy_mqC_R.js";
import { n as logConfigUpdated } from "./logging-DS0Tn5Cy.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CR5fy2A5.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-0qeP8z5Q.js";
import { t as formatHealthCheckFailure } from "./health-format-BAoLXknd.js";
import { n as doctorShellCompletion } from "./doctor-completion-C_yaSCLI.js";
...
async function cleanupLegacyLaunchdService(params) {
	...
	try {
		await fsPromises.access(params.plistPath);
	} catch {
		return null;
	}
	const dest = path.join(trashDir, `${params.label}-${Date.now()}.plist`);
	try {
		await fsPromises.rename(params.plistPath, dest);
		return dest;
	} catch {
		return null;
	}
...
async function maybeRepairUiProtocolFreshness(_runtime, prompter) {
	...
	try {
		const [schemaStats, uiStats] = await Promise.all([fsPromises.stat(schemaPath).catch(() => null), fsPromises.stat(uiIndexPath).catch(() => null)]);
		if (schemaStats && !uiStats) {
			...
			if (!await fsPromises.stat(uiSourcesPath).catch(() => null)) {
