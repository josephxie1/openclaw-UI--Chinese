import { r as STATE_DIR } from "./paths-B9jPXz5d.js";
import { p as defaultRuntime, t as createSubsystemLogger, v as CHANNEL_IDS } from "./subsystem-D2eqGDrA.js";
import { v as resolveUserPath } from "./utils-XeuG5BG2.js";
import { et as getBlockedNetworkModeReason, j as loadConfig } from "./auth-profiles-CZvcgpJo.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-a8AT_RWh.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-Cuihcz_O.js";
import { i as openBoundaryFile, u as resolvePathViaExistingAncestorSync } from "./openclaw-root-PXe5cw0N.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-HX9fGcwF.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Bqfz8RAo.js";
import { $ as canonicalizeMainSessionAlias, B as acquireSessionWriteLock, et as resolveAgentMainSessionKey } from "./sessions-Bi0azzm9.js";
import { r as isLoopbackHost } from "./net-BmOGX3t_.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-DfXt8uIy.js";
import { A as DEFAULT_OPENCLAW_BROWSER_COLOR, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_BROWSER_EVALUATE_ENABLED } from "./chrome-CLydEGCA.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, o as deriveDefaultBrowserCdpPortRange, r as registerBrowserRoutes, s as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-CgtJLU5F.js";
import { n as installBrowserCommonMiddleware, t as installBrowserAuthMiddleware } from "./server-middleware-dIszEUpi.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-X5jNuF8G.js";
