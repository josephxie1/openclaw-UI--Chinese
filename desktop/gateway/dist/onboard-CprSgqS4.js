...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-DoASNpMz.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Cc-pFaG2.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DpZTTZBG.js";
import { t as runOnboardingWizard } from "./onboarding-C1zf6Bx7.js";
import { n as logConfigUpdated } from "./logging-D-uB4OXg.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BTK_m1tY.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-B2wfm7ge.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-F2BAu2Bo.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DvZhjURD.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BnAQC5Hg.js");
