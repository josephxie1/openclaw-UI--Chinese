...
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-DpzIdlnz.js";
import { B as safeParseJson, J as danger, T as CONFIG_DIR, X as logVerbose, t as createSubsystemLogger } from "./subsystem-BOPdQ1OK.js";
import { f as DEFAULT_ACCOUNT_ID, p as normalizeAccountId } from "./session-key-CPPWn8gW.js";
import { On as withFileLock$1, U as writeConfigFile, V as readConfigFileSnapshotForWrite, pn as resolveTelegramPreviewStreamMode, z as loadConfig } from "./model-selection-ByiezZu1.js";
import { t as isTruthyEnvValue } from "./env-Dd9-xtX7.js";
import { l as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DDUisxu9.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-7JhsTcRW.js";
import { t as redactSensitiveText } from "./redact-BbTfxkPJ.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-gzROynDW.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-CggdN3ss.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-DtOsiJ5s.js";
import { t as renderMarkdownWithMarkers } from "./render-DehvxLfa.js";
import { i as recordChannelActivity, n as createTelegramRetryRunner } from "./retry-policy-CUYlSKmA.js";
import { t as resolveFetch } from "./fetch-CS27LfIA.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-CdjlUaH0.js";
import { n as normalizePollInput } from "./polls-CwwHzYBM.js";
...
//#endregion
export { readJsonFileWithFallback as $, extractTelegramLocation as A, normalizeAllowFrom as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, mergeDmAllowFromSources as G, resolveSenderAllowMatch as H, resolveTelegramReplyId as I, toLocationContext as J, resolveGroupAllowFromSources as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, upsertChannelPairingRequest as Q, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, firstDefined as U, normalizeDmAllowFromWithStore as V, isSenderIdAllowed as W, readChannelAllowFromStore as X, addChannelAllowFromStoreEntry as Y, removeChannelAllowFromStoreEntry as Z, resolveTelegramFetch as _, reactMessageTelegram as a, resolveTelegramTargetChatType as at, buildGroupLabel as b, sendStickerTelegram as c, wasSentByBot as d, writeJsonFileAtomically as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, parseTelegramTarget as it, hasBotMention as j, expandTextLinks as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, listPairingChannels as nt, sendMessageTelegram as o, markdownToTelegramChunks as p, formatLocationText as q, deleteMessageTelegram as r, isVoiceCompatibleAudio as rt, sendPollTelegram as s, buildInlineKeyboard as t, getPairingAdapter as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, isSenderAllowed as z };