import { et as resolvePreferredOpenClawTmpDir } from "./utils-C2rp27T1.js";
import { Ht as loadConfig } from "./model-selection-Byqz32hU.js";
import { _ as maxBytesForKind, l as extensionForMime } from "./image-ops-BwGmDpam.js";
import { C as normalizeDiscordToken, S as resolveDiscordAccount } from "./plugins-f8FOOJGM.js";
import { a as requireTargetKind, i as parseTargetPrefixes, n as ensureTargetId, r as parseTargetMention, t as buildMessagingTarget } from "./targets-C_cVT-c_.js";
import { t as resolveFetch } from "./fetch-DRmPz6Ll.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-wSxHKVU4.js";
import { i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-YVsOQNJl.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-C6BbKelL.js";
import { a as loadWebMedia, o as loadWebMediaRaw } from "./ir-CuwuI9Dp.js";
import { i as recordChannelActivity, t as createDiscordRetryRunner } from "./retry-policy-CRErIuSy.js";
import { n as normalizePollInput, t as normalizePollDurationHours } from "./polls-C5zCULbA.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-jryZYrre.js";
import { t as convertMarkdownTables } from "./tables-DwftZVrO.js";
...
async function ensureOggOpus(filePath) {
	...
	if (path.extname(filePath).toLowerCase() === ".ogg") try {
		...
		if (stdout.trim().toLowerCase() === "opus") return {
			path: filePath,
			cleanup: false
		};
	} catch {}
...
//#endregion
export { fetchChannelPermissionsDiscord as $, addRoleDiscord as A, resolveChannelEntryMatchWithFallback as At, removeRoleDiscord as B, fetchMessageDiscord as C, resolveDiscordSystemLocation as Ct, readMessagesDiscord as D, buildChannelKeyCandidates as Dt, pinMessageDiscord as E, applyChannelMatchMeta as Et, fetchRoleInfoDiscord as F, createChannelDiscord as G, listGuildEmojisDiscord as H, fetchVoiceStatusDiscord as I, moveChannelDiscord as J, deleteChannelDiscord as K, kickMemberDiscord as L, createScheduledEventDiscord as M, fetchChannelInfoDiscord as N, searchMessagesDiscord as O, normalizeChannelSlug as Ot, fetchMemberInfoDiscord as P, DiscordSendError as Q, listGuildChannelsDiscord as R, editMessageDiscord as S, formatDiscordUserTag as St, listThreadsDiscord as T, fetchDiscord as Tt, uploadEmojiDiscord as U, timeoutMemberDiscord as V, uploadStickerDiscord as W, setChannelPermissionDiscord as X, removeChannelPermissionDiscord as Y, stripUndefinedFields as Z, sendStickerDiscord as _, resolveDiscordOwnerAllowFrom as _t, sendDiscordComponentMessage as a, parseDiscordTarget as at, createThreadDiscord as b, shouldEmitDiscordReactionNotification as bt, parseDiscordComponentCustomId as c, listDiscordDirectoryPeersLive as ct, parseDiscordModalCustomIdForCarbon as d, normalizeDiscordAllowList as dt, fetchMemberGuildPermissionsDiscord as et, readDiscordComponentSpec as f, normalizeDiscordSlug as ft, sendPollDiscord as g, resolveDiscordMemberAccessState as gt, sendMessageDiscord as h, resolveDiscordGuildEntry as ht, removeReactionDiscord as i, chunkDiscordTextWithMode as it, banMemberDiscord as j, resolveChannelMatchConfig as jt, unpinMessageDiscord as k, resolveChannelEntryMatch as kt, parseDiscordComponentCustomIdForCarbon as l, allowListMatches as lt, resolveDiscordModalEntry as m, resolveDiscordChannelConfigWithFallback as mt, reactMessageDiscord as n, createDiscordClient as nt, createDiscordFormModal as o, resolveDiscordChannelId as ot, resolveDiscordComponentEntry as p, resolveDiscordAllowListMatch as pt, editChannelDiscord as q, removeOwnReactionsDiscord as r, createDiscordRestClient as rt, formatDiscordComponentEventText as s, listDiscordDirectoryGroupsLive as st, fetchReactionsDiscord as t, hasAnyGuildPermissionDiscord as tt, parseDiscordModalCustomId as u, isDiscordGroupAllowedByPolicy as ut, sendVoiceMessageDiscord as v, resolveDiscordShouldRequireMention as vt, listPinsDiscord as w, resolveTimestampMs as wt, deleteMessageDiscord as x, formatDiscordReactionEmoji as xt, sendWebhookMessageDiscord as y, resolveGroupDmAllow as yt, listScheduledEventsDiscord as z };