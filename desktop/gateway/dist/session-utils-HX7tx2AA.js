...
import { Et as isWorkspaceRelativeAvatarPath, Gn as resolveOpenClawAgentDir, Ot as resolveAvatarMime, St as isAvatarHttpUrl, bi as DEFAULT_PROVIDER, bt as AVATAR_MAX_BYTES, dr as resolveDefaultModelForAgent, j as loadConfig, sr as parseModelRef, tr as inferUniqueProviderFromConfiguredModels, ur as resolveConfiguredModelRef, vi as DEFAULT_CONTEXT_TOKENS, wt as isPathWithinRoot, xt as isAvatarDataUrl, yi as DEFAULT_MODEL } from "./auth-profiles-CZvcgpJo.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-a8AT_RWh.js";
import { c as normalizeMainKey, s as normalizeAgentId, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-Cuihcz_O.js";
import { a as openBoundaryFileSync } from "./openclaw-root-PXe5cw0N.js";
import { $ as canonicalizeMainSessionAlias, M as readSessionTitleFieldsFromTranscript, Z as resolveFreshSessionTotalTokens, c as loadSessionStore, ct as buildGroupDisplayName, et as resolveAgentMainSessionKey, nt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-Bi0azzm9.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-DECvU61g.js").then((n) => n.r);
