...
import { n as getDiagnosticSessionState, r as pruneDiagnosticSessionStates, t as diagnosticSessionStates } from "./diagnostic-session-state-z4ityqlG.js";
...
function startDiagnosticHeartbeat(config) {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-B4sK-WbO.js").then(({ pruneStaleCommandPolls }) => {
