...
import { h as pathExists, y as resolveUserPath } from "./utils-C2rp27T1.js";
import "./thinking-CJzCCbYy.js";
import "./reply-CoPc6XC4.js";
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-hUtx0Gmw.js";
import { m as restoreTerminalState } from "./subsystem-DoASNpMz.js";
...
import { r as resolveCliName, t as formatCliCommand } from "./command-format-DELazozB.js";
...
import { b as waitForGatewayReachable, d as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint, p as probeGatewayReachable } from "./onboard-helpers-Cc-pFaG2.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-1Ea7_SPN.js").then((n) => n.r);
