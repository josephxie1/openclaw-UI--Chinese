...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-C1vRJs5w.js";
...
function startDiagnosticHeartbeat(config) {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-D-rEnGkQ.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
