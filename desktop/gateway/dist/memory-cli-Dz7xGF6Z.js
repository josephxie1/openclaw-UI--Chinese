...
import { L as colorize, N as setVerbose, R as isRich, b as shortenHomeInString, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-XeuG5BG2.js";
import { j as loadConfig, ln as splitShellArgs, rt as parseDurationMs } from "./auth-profiles-CZvcgpJo.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-C6x4pKyg.js";
import { t as formatDocsLink } from "./links-CWyy563z.js";
import { r as withManager } from "./cli-utils-B7nApBgk.js";
import { t as formatHelpExamples } from "./help-format-DYI1Qsgl.js";
import { n as withProgress, r as withProgressTotals } from "./progress-CoLN8zGu.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-_0QsXryv.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-DJ2nuij3.js").then((n) => n.t);
