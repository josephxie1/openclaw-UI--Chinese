import { c as ensureDir, g as resolveConfigDir, y as resolveUserPath } from "./utils-C2rp27T1.js";
import { t as runCommandWithTimeout } from "./exec-Cga3tCb5.js";
import { d as hasBinary } from "./frontmatter-DQ4Janwj.js";
import { i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, x as resolveSkillKey } from "./skills-DtK0BEAU.js";
...
import { a as extractArchive$1, d as resolveArchiveOutputPath, f as stripArchivePath, p as validateArchiveEntryPath, r as safePathSegmentHashed, u as isWindowsDrivePath } from "./install-safe-path-Bq5GdNUl.js";
...
async function installDownloadSpec(params) {
	...
	try {
		...
		if (stat.isSymbolicLink()) throw new Error(`targetDir is a symlink: ${targetDir}`);
		if (!stat.isDirectory()) throw new Error(`targetDir is not a directory: ${targetDir}`);
	} catch (err) {
