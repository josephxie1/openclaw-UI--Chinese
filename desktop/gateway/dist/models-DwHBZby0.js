...
import { L as colorize, R as isRich$1, x as shortenHomePath, z as theme } from "./utils-CfiuWRBq.js";
import { Ai as DEFAULT_MODEL, Bn as listProfilesForProvider, Cr as resolveModelRefFromString, Hn as setAuthProfileOrder, Kn as ensureAuthProfileStore, M as loadConfig, Mi as resolveAuthProfileDisplayLabel, Un as upsertAuthProfile, _r as parseModelRef, ai as resolveAwsSdkEnvVarName, br as resolveConfiguredModelRef, c as resolveProfileUnusableUntilForDisplay, ci as getShellEnvAppliedKeys, cr as buildModelAliasIndex, ct as parseDurationMs, di as shouldEnableShellEnvFallback, er as resolveAuthStorePathForDisplay, gr as normalizeProviderId, ii as resolveApiKeyForProvider, ji as DEFAULT_PROVIDER, lr as findNormalizedProviderValue, ni as getCustomProviderApiKey, oi as resolveEnvApiKey, pr as modelKey, t as resolveAuthProfileOrder, tr as resolveOpenClawAgentDir, xr as resolveDefaultModelForAgent } from "./auth-profiles-pmKds52w.js";
import { t as formatCliCommand } from "./command-format-D-E6F1gN.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-CLHs7Zj4.js";
import { r as resolveForwardCompatModel } from "./model-B5Fh7BHp.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-IPcPNruH.js";
import { An as loadProviderUsageSummary, Ft as describeFailoverError, Mn as formatUsageWindowSummary, Nn as resolveUsageProviderId, Pn as maskApiKey, _ as runEmbeddedPiAgent, dn as DEFAULT_OAUTH_WARN_MS, fn as buildAuthHealthSummary, pn as formatRemainingShort } from "./subagent-registry-BOXhQT2L.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CVD1Nvmu.js";
import { t as ensureOpenClawModelsJson } from "./models-config-VvbMbqSV.js";
import { n as loadModelCatalog } from "./model-catalog-DyJVUu-R.js";
import { r as withProgressTotals } from "./progress-Be7vAY6t.js";
import { d as openUrl } from "./onboard-helpers-D6FHY_pZ.js";
...
import { n as redactSecrets } from "./format-C2yPnOJl.js";
import { t as __exportAll } from "./gateway-cli-Ci3pDF9D.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DVKFjkqP.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-C660xO4x.js";
import { n as logConfigUpdated } from "./logging-Ck3u149k.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Bcf4uGRP.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-CFmB655Q.js");
	const { ensureAuthProfileStore } = await import("./auth-profiles-BWUbCjK2.js");
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CRognqlG.js");
