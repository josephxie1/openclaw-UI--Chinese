import { g as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-B9jPXz5d.js";
import { B as createInternalHookEvent, D as getActivePluginRegistry, H as triggerInternalHook, V as registerInternalHook, a as setConsoleSubsystemFilter, j as createEmptyPluginRegistry, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger, v as CHANNEL_IDS, z as clearInternalHooks } from "./subsystem-D2eqGDrA.js";
import { B as getChildLogger, E as isPlainObject, H as getResolvedLoggerSettings, L as colorize, N as setVerbose, R as isRich, T as truncateUtf16Safe, V as getLogger, j as logVerbose, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-XeuG5BG2.js";
import "./boolean-DtWR5bt3.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { A as createConfigIO, Ct as isAvatarImageDataUrl, Dn as resolveSubagentMaxConcurrent, Dt as looksLikeAvatarPath, En as resolveAgentMaxConcurrent, F as resolveConfigSnapshotHash, L as writeConfigFile, M as parseConfigJson5, N as readConfigFileSnapshot, O as migrateLegacyConfig, P as readConfigFileSnapshotForWrite, R as validateConfigObjectWithPlugins, St as isAvatarHttpUrl, Xn as buildAllowedModelSet, Yn as isPidAlive, _r as resolveThinkingDefault, ar as normalizeModelSelection, bi as DEFAULT_PROVIDER, bt as AVATAR_MAX_BYTES, cr as resolveAllowedModelRef, di as normalizeSecretInput, dr as resolveDefaultModelForAgent, er as getModelRefStatus, fr as resolveHooksGmailModel, hn as ensureControlUiAllowedOriginsForNonLoopbackBind, hr as resolveSubagentConfiguredModelSelection, it as parseByteSize, j as loadConfig, mn as applyLegacyMigrations, nr as isCliProvider, pn as applyMergePatch, rt as parseDurationMs, ur as resolveConfiguredModelRef, vi as DEFAULT_CONTEXT_TOKENS, wn as buildTalkConfigResponse, yi as DEFAULT_MODEL, z as OpenClawSchema } from "./auth-profiles-CZvcgpJo.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-a8AT_RWh.js";
...
import { a as openBoundaryFileSync, f as isNotFoundPathError, h as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-PXe5cw0N.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-CSag7MO2.js";
import "./github-copilot-token-CHThtPpe.js";
import "./host-env-security-DWcSD4kP.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-DR9Qjj6f.js";
import "./env-vars-tQ4AIdQq.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-yJ4VbgqY.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-B0pLVTKg.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Dz7xGF6Z.js";
import { n as resolveMemorySearchConfig } from "./manager-DJ2nuij3.js";
import "./gemini-auth-BwpwqMEH.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DdlITp72.js";
import "./query-expansion-C6x4pKyg.js";
import "./retry-BoP38Evl.js";
import { a as ToolInputError } from "./target-errors-zRZr7S-r.js";
...
import { r as isRestartEnabled } from "./commands-KKgWclzv.js";
import "./commands-registry-Dg8Rixk-.js";
import { S as extractTextFromChatContent } from "./image-UdZytPX6.js";
import "./tool-display-TYTccNWv.js";
import { r as getChannelActivity } from "./retry-policy-CtbxW3Xf.js";
import { d as registerUnhandledRejectionHandler } from "./runner-QvrPoSIs.js";
import { n as loadModelCatalog } from "./model-catalog-B2D_BloA.js";
import "./fetch-C-_zRqDA.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-DjFn_dIY.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-BMFhaWeS.js";
import { _ as matchSystemRunApprovalBinding, g as buildSystemRunApprovalBinding, h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext, v as missingSystemRunApprovalBinding, y as toSystemRunApprovalMismatchError } from "./nodes-screen-BQT-wV6c.js";
import { n as resolveSystemRunCommand } from "./system-run-command-DlF20rUR.js";
...
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-rB-A7vpt.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-JlIz56oG.js";
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-CVfpjHAz.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BJKGMQ48.js";
import { n as normalizePollInput } from "./polls-BGmy9scw.js";
import "./tables-D_QG3PE3.js";
import "./server-lifecycle-BKrYFSKV.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DjNEVTNM.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BVseVG8h.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-BZsoToeO.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-DobOP4bl.js";
...
import { t as formatHelpExamples } from "./help-format-DYI1Qsgl.js";
import { n as withProgress } from "./progress-CoLN8zGu.js";
import "./replies-BPCok6xi.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-gyti7QOy.js";
import "./prompt-style-BcyiLcfo.js";
import "./pairing-labels-D55D0emZ.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BdELrtRZ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-s9nOTFhf.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-REINo8Sd.js";
import { n as inheritOptionFromParent } from "./command-options-D_KEIae-.js";
import { t as WizardCancelledError } from "./prompts-CNzp9M83.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BIKdWN0T.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-C-FrqzLS.js";
import { t as isWithinDir } from "./path-safety-DIscn2cd.js";
...
import "./channels-status-issues-D_svjtS4.js";
import { a as applySensitiveHints, c as applyDerivedTags, i as restoreRedactedValues, n as redactConfigSnapshot, o as buildBaseHints, s as mapSensitivePaths, t as redactConfigObject } from "./redact-snapshot-BpYHj_2r.js";
...
import "./lifecycle-core-CwnZfDF-.js";
import "./systemd-hints-BgQkg50P.js";
import { t as parsePort$1 } from "./parse-port-CboE2EQm.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-Ck3ghxmG.js";
import "./diagnostics-DsU2-25q.js";
import "./table-CwwhM1rv.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BVrDWl-C.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-ByHU0oJW.js";
import { a as isNodeCommandAllowed, n as collectEnabledInsecureOrDangerousFlags, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-CZpTm9qz.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-W4cDqll_.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-D1Ixgwvu.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-DucjJfYw.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DnxiZ3-i.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CzSKGcio.js";
import { i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-g3gntGWT.js";
import { t as runOnboardingWizard } from "./onboarding-C4L4mDDp.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BgL-PTAU.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-D3kWJM5f.js";
import "./node-service-uEqF1hJF.js";
import "./status.update-CTEOoPYI.js";
import { t as installSkill } from "./skills-install-CK2KBS4X.js";
import { t as runGatewayUpdate } from "./update-runner-DRLuJ_8M.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CTSdvpRh.js";
import { n as forceFreePortAndWait } from "./ports-COOg4_3e.js";
	...
	"sessions.activity": ({ respond }) => {
		...
		try {
			...
			for (const [key, entry] of Object.entries(store)) {
				...
				if (sessionsMap.has(lower)) continue;
...
const configHandlers = {
	...
	"config.raw": async ({ params, respond }) => {
		...
		try {
			...
			if (parseResult.ok) {
				const { redactConfigRaw: doRedact } = await import("./redact-snapshot-BpYHj_2r.js").then((n) => n.r);
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-GywcMsVk.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-rB-A7vpt.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-zaitxlPl.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-sFkGs-VC.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-BGjVHnsp.js").then((n) => n.n);
