import { g as resolveStateDir, m as resolveOAuthDir, o as resolveConfigPath } from "./paths-BafI8hAX.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-hUtx0Gmw.js";
import { s as normalizeAgentId } from "./session-key-B9ePuoPx.js";
import { Ft as safeStat, Mt as formatPermissionDetail, Nt as formatPermissionRemediation, Pt as inspectPathPermissions, Rr as INCLUDE_KEY, Vt as createConfigIO, _n as normalizeNetworkMode, gn as isDangerousNetworkMode, rr as normalizeTrustedSafeBinDirs, zr as MAX_INCLUDE_DEPTH } from "./model-selection-Byqz32hU.js";
import { t as formatCliCommand } from "./command-format-DELazozB.js";
import { i as isPathInside, n as MANIFEST_KEY, r as extensionUsesSkippedScannerPath } from "./legacy-names-C_KogSD8.js";
import { u as normalizePluginsConfig } from "./manifest-registry-ZL7mwhHa.js";
import { l as normalizeStringEntries } from "./dock-ePhV6VyM.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-CmxjO7-N.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-A8hfyKgi.js";
...
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-0Qn8DVy0.js";
import { i as loadWorkspaceSkillEntries } from "./skills-DtK0BEAU.js";
import { n as formatErrorMessage } from "./errors-BRgSJZKa.js";
import { n as listChannelPlugins } from "./plugins-f8FOOJGM.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-C25v8qFZ.js";
import { t as GatewayClient, zt as normalizeDeviceMetadataForPolicy } from "./client-Bdxi_Lgo.js";
import { c as READ_SCOPE, t as buildGatewayConnectionDetails } from "./call-CKmCm4sY.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CvBGUb6r.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-C8f2BxZQ.js";
import { l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-BRXBAM0X.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-DvVgNs5Q.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-DU1iZzvF.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-BCPDDDIZ.js";
import { c as normalizeTelegramAllowFromEntry, s as isNumericTelegramUserId, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-Dew0_hXH.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-DfK9g6fg.js";
