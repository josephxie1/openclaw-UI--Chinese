import { r as STATE_DIR } from "./paths-BafI8hAX.js";
import { y as resolveUserPath } from "./utils-C2rp27T1.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-hUtx0Gmw.js";
import { p as defaultRuntime, t as createSubsystemLogger, v as CHANNEL_IDS } from "./subsystem-DoASNpMz.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-B9ePuoPx.js";
import { i as openBoundaryFile, u as resolvePathViaExistingAncestorSync } from "./openclaw-root-CMyEcfUW.js";
import { Ht as loadConfig, hn as getBlockedNetworkModeReason } from "./model-selection-Byqz32hU.js";
import { t as formatCliCommand } from "./command-format-DELazozB.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-CrsxKKLj.js";
import { A as DEFAULT_OPENCLAW_BROWSER_COLOR, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_BROWSER_EVALUATE_ENABLED } from "./chrome-C2yG3uod.js";
import { i as isLoopbackHost } from "./ws-Cf71ITZP.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, o as deriveDefaultBrowserCdpPortRange, r as registerBrowserRoutes, s as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-0Qn8DVy0.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-DtK0BEAU.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BTugjn_E.js";
import { n as installBrowserCommonMiddleware, t as installBrowserAuthMiddleware } from "./server-middleware-x1gE0tXy.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-DiWwTdw2.js";
import { lt as canonicalizeMainSessionAlias, ut as resolveAgentMainSessionKey, wt as acquireSessionWriteLock } from "./sessions-VdaDAoct.js";
