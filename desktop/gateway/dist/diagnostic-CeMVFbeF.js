...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-C0Sxjfox.js";
...
function startDiagnosticHeartbeat(config) {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-CPEQWmAp.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
