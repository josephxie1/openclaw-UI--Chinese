import { D as runExec, G as resolveAgentModelFallbackValues, K as resolveAgentModelPrimaryValue } from "./agent-scope-2WLEGCGu.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-BOPdQ1OK.js";
import { D as resolveApiKeyForProvider, Dn as resolveOpenClawAgentDir, E as requireApiKey, J as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, X as mergeInboundPathRoots, Y as isInboundPathAllowed, Z as resolveIMessageAttachmentRoots, c as normalizeProviderId, h as normalizeGoogleModelId, z as loadConfig } from "./model-selection-ByiezZu1.js";
import { t as normalizeChatType } from "./chat-type-DFDuk3FY.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-7JhsTcRW.js";
import { T as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-TZgLmQp0.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-C2Cjw6eP.js";
import { n as fetchWithTimeout } from "./fetch-timeout-C-LcqI96.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-WQNbx9gl.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DTGVRPWb.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-BfFKqMVS.js").then((n) => n.r);
