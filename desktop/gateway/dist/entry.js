...
if (!isMainModule({
	...
	function tryHandleRootHelpFastPath(argv) {
		...
		import("./program-CaaILLx4.js").then(({ buildProgram }) => {
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-CBBtwIUE.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
