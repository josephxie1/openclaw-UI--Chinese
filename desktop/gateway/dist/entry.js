...
if (!isMainModule({
	...
	function tryHandleRootHelpFastPath(argv) {
		...
		import("./program-CnT0148S.js").then(({ buildProgram }) => {
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-CrlVbpc_.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
