...
if (!isMainModule({
	...
	function tryHandleRootHelpFastPath(argv) {
		...
		import("./program-BnScETrD.js").then(({ buildProgram }) => {
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-DRa4qDdG.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
