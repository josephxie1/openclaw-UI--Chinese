import { g as resolveStateDir, n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-DPETYfXn.js";
import { p as defaultRuntime } from "./subsystem-Cg_UWVEG.js";
import { m as pathExists, z as theme } from "./utils-CfiuWRBq.js";
import "./boolean-YY6K2DFz.js";
import { P as readConfigFileSnapshot, R as writeConfigFile } from "./auth-profiles-BghqkBM8.js";
import { n as replaceCliName, r as resolveCliName, t as formatCliCommand } from "./command-format-D-E6F1gN.js";
import "./agent-scope-CIzpI5xh.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-3Za7U6qY.js";
import { t as runCommandWithTimeout } from "./exec-BAZSkTa2.js";
...
import { Vt as trimLogTail } from "./subagent-registry-BYIe-M9p.js";
...
import { r as formatDurationPrecise } from "./format-duration-D7xMTaM8.js";
...
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CZ2QuH-y.js";
...
import { n as stylePromptMessage } from "./prompt-style-D01Z207U.js";
...
import { r as installCompletion } from "./completion-cli-BN1WMItD.js";
import "./register.subclis-CDmc5suJ.js";
import "./command-registry-CZAC6kj-.js";
import "./program-context-BTRS7TOF.js";
import "./daemon-install-helpers-Dk8BToL9.js";
import { r as parseSemver } from "./runtime-guard-DzsNMb_E.js";
import "./systemd-BPIlmdfK.js";
import { t as resolveGatewayService } from "./service-C4_4PrdB.js";
import "./lifecycle-core-Cwz4Idoe.js";
import "./systemd-hints-D-OrV2JJ.js";
import { c as renderRestartDiagnostics, d as runDaemonInstall, i as runDaemonRestart, l as terminateStaleGatewayPids, u as waitForGatewayHealthyRestart } from "./daemon-cli-CeWXfkg6.js";
import "./diagnostics-Ca1e5iIs.js";
import { t as renderTable } from "./table-D_8bv6eo.js";
import "./health-Cgxhr072.js";
import "./control-ui-assets-GGFclzNd.js";
import { _ as resolveUpdateChannelDisplay, c as DEFAULT_GIT_CHANNEL, d as channelToNpmTag, f as formatUpdateChannelLabel, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, i as fetchNpmTagVersion, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CpsEsWss.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-C70oszTJ.js";
import { a as globalInstallArgs, c as readPackageVersion, i as detectGlobalInstallManagerForRoot, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, r as detectGlobalInstallManagerByPresence, s as readPackageName, t as runGatewayUpdate } from "./update-runner-Dy_mqC_R.js";
import "./logging-DS0Tn5Cy.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-DqncwDY1.js";
import "./doctor-config-flow-CR5fy2A5.js";
import "./systemd-linger-0qeP8z5Q.js";
import "./health-format-BAoLXknd.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-D2jrtmw8.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-C_yaSCLI.js";
...
async function isGitCheckout(root) {
	try {
		await fsPromises.stat(path.join(root, ".git"));
		return true;
	} catch {
		return false;
	}
...
async function isEmptyDir(targetPath) {
	try {
		return (await fsPromises.readdir(targetPath)).length === 0;
	} catch {
		return false;
	}
}
...
`;
		...
		await fsPromises.writeFile(scriptPath, scriptContent, { mode: 493 });
		return scriptPath;
	} catch {
		return null;
	}
...
async function updateCommand(opts) {
	...
	if (updateInstallKind !== "git") {
		...
		targetVersion = explicitTag ? await resolveTargetVersion(tag, timeoutMs) : await resolveNpmChannelTag({
			channel,
			timeoutMs
		}).then((resolved) => {
			tag = resolved.tag;
	...
	if (opts.dryRun) {
		...
		else actions.push(`Run global package manager update with spec openclaw@${tag}`);
