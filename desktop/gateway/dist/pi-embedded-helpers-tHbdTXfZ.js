import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-2WLEGCGu.js";
import { a as resolveGatewayPort, n as STATE_DIR } from "./paths-DpzIdlnz.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-BOPdQ1OK.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-CPPWn8gW.js";
import { R as createConfigIO, U as writeConfigFile, tt as getBlockedNetworkModeReason, z as loadConfig } from "./model-selection-ByiezZu1.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-Dd9-xtX7.js";
import { t as generateSecureToken } from "./secure-random-D7Pne8Yn.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-7JhsTcRW.js";
import { A as resolveExistingPathsWithinRoot, B as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, C as ensureChromeExtensionRelayServer, D as DEFAULT_DOWNLOAD_DIR, F as isLoopbackHost, H as DEFAULT_OPENCLAW_BROWSER_COLOR, L as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, M as resolveWritablePathWithinRoot, O as DEFAULT_TRACE_DIR, P as normalizeBrowserFormField, R as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, U as DEFAULT_OPENCLAW_BROWSER_ENABLED, V as DEFAULT_BROWSER_EVALUATE_ENABLED, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./chrome-DTG4vlhY.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-B1Z-7WdS.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CDRPo8iT.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-gzROynDW.js";
import { t as SsrFBlockedError } from "./ssrf-w8ZK882q.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-DAgoVYrk.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-Dbx8t3Tf.js";
import { H as canonicalizeMainSessionAlias, J as acquireSessionWriteLock, U as resolveAgentMainSessionKey } from "./sessions-CRE_KdLn.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-nqGHGLO8.js";
import { o as normalizeThinkLevel } from "./thinking-BoOZzGqx.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DtgtG4-1.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DtgtG4-1.js")).closePlaywrightBrowserConnection();
		} catch {}
