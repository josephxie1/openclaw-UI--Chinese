import { g as resolveStateDir } from "./paths-DPETYfXn.js";
import { a as logError, i as logDebug } from "./exec-BAZSkTa2.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_IDS } from "./message-channel-B603rVd0.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-BpaGxV1q.js";
import { a as resolvePairingPaths, c as readJsonFile, i as pruneExpiredPending, l as writeJsonAtomic, n as verifyPairingToken, r as rejectPendingPairingRequest, s as createAsyncLock, t as generatePairingToken } from "./pairing-token-CMsOsUWQ.js";
import { i as isSecureWebSocketUrl, p as rawDataToString } from "./net-CWnLPYEi.js";
...
const ConfigRawParamsSchema = Type.Object({}, { additionalProperties: false });
...
const validateConfigRawParams = ajv.compile(ConfigRawParamsSchema);
...
//#endregion
export { validateNodePairListParams as $, normalizeFingerprint as $t, validateCronRunsParams as A, validateWizardStatusParams as At, validateExecApprovalResolveParams as B, approveDevicePairing as Bt, validateConfigSchemaParams as C, validateUpdateRunParams as Ct, validateCronListParams as D, validateWizardCancelParams as Dt, validateCronAddParams as E, validateWebLoginWaitParams as Et, validateDevicePairRejectParams as F, parseSessionLabel as Ft, validateLogsTailParams as G, removePairedDevice as Gt, validateExecApprovalsNodeGetParams as H, getPairedDevice as Ht, validateDevicePairRemoveParams as I, buildDeviceAuthPayload as It, validateNodeEventParams as J, rotateDeviceToken as Jt, validateModelsListParams as K, requestDevicePairing as Kt, validateDeviceTokenRevokeParams as L, buildDeviceAuthPayloadV3 as Lt, validateCronUpdateParams as M, ErrorCodes as Mt, validateDevicePairApproveParams as N, errorShape as Nt, validateCronRemoveParams as O, validateWizardNextParams as Ot, validateDevicePairListParams as P, SESSION_LABEL_MAX_LENGTH as Pt, validateNodePairApproveParams as Q, roleScopesAllow as Qt, validateDeviceTokenRotateParams as R, normalizeDeviceMetadataForAuth as Rt, validateConfigRawParams as S, validateToolsCatalogParams as St, validateConnectParams as T, validateWebLoginStartParams as Tt, validateExecApprovalsNodeSetParams as U, listDevicePairing as Ut, validateExecApprovalsGetParams as V, ensureDeviceToken as Vt, validateExecApprovalsSetParams as W, rejectDevicePairing as Wt, validateNodeInvokeResultParams as X, updatePairedDeviceMetadata as Xt, validateNodeInvokeParams as Y, summarizeDeviceTokens as Yt, validateNodeListParams as Z, verifyDeviceToken as Zt, validateChatInjectParams as _, validateSkillsInstallParams as _t, validateAgentWaitParams as a, validatePushTestParams as at, validateConfigGetParams as b, validateTalkConfigParams as bt, validateAgentsFilesGetParams as c, validateSessionsCompactParams as ct, validateAgentsListParams as d, validateSessionsPatchParams as dt, deriveDeviceIdFromPublicKey as en, validateNodePairRejectParams as et, validateAgentsUpdateParams as f, validateSessionsPreviewParams as ft, validateChatHistoryParams as g, validateSkillsBinsParams as gt, validateChatAbortParams as h, validateSessionsUsageParams as ht, validateAgentParams as i, validatePollParams as it, validateCronStatusParams as j, PROTOCOL_VERSION as jt, validateCronRunParams as k, validateWizardStartParams as kt, validateAgentsFilesListParams as l, validateSessionsDeleteParams as lt, validateChannelsStatusParams as m, validateSessionsResolveParams as mt, formatValidationErrors as n, normalizeDevicePublicKeyBase64Url as nn, validateNodePairVerifyParams as nt, validateAgentsCreateParams as o, validateRequestFrame as ot, validateChannelsLogoutParams as p, validateSessionsResetParams as pt, validateNodeDescribeParams as q, revokeDeviceToken as qt, validateAgentIdentityParams as r, verifyDeviceSignature as rn, validateNodeRenameParams as rt, validateAgentsDeleteParams as s, validateSendParams as st, GatewayClient as t, loadOrCreateDeviceIdentity as tn, validateNodePairRequestParams as tt, validateAgentsFilesSetParams as u, validateSessionsListParams as ut, validateChatSendParams as v, validateSkillsStatusParams as vt, validateConfigSetParams as w, validateWakeParams as wt, validateConfigPatchParams as x, validateTalkModeParams as xt, validateConfigApplyParams as y, validateSkillsUpdateParams as yt, validateExecApprovalRequestParams as z, normalizeDeviceMetadataForPolicy as zt };