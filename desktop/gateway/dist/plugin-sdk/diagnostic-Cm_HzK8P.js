...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-cwjDplnM.js";
...
function startDiagnosticHeartbeat(config) {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-B2aEX8aR.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
