import { X as isPrivateOrLoopbackIpAddress, Y as isLoopbackIpAddress, Z as normalizeIpAddress, n as loadConfig } from "./config-Zs384y2C.js";
import { O as CONFIG_DIR, mt as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger } from "./subsystem-D7KkLxSJ.js";
import { H as isPathInside, V as isNotFoundPathError } from "./agent-scope-DmMs4gD_.js";
import { i as isErrno } from "./errors-BMOVwRE7.js";
import { r as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DFT7bdmo.js";
import { s as resolvePinnedHostnameWithPolicy } from "./ssrf-D-Eyl7pQ.js";
...
//#endregion
export { resolveStrictExistingPathsWithinRoot as A, DEFAULT_OPENCLAW_BROWSER_ENABLED as B, ensureChromeExtensionRelayServer as C, DEFAULT_TRACE_DIR as D, DEFAULT_DOWNLOAD_DIR as E, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as F, isLoopbackHost as H, DEFAULT_AI_SNAPSHOT_MAX_CHARS as I, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as L, DEFAULT_FILL_FIELD_TYPE as M, normalizeBrowserFormField as N, DEFAULT_UPLOAD_DIR as O, DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH as P, DEFAULT_BROWSER_EVALUATE_ENABLED as R, withCdpSocket as S, withNoProxyForLocalhost as T, isSecureWebSocketUrl as U, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as V, rawDataToString as W, withBrowserNavigationPolicy as _, resolveOpenClawUserDataDir as a, fetchOk as b, resolveBrowserExecutableForPlatform as c, formatAriaSnapshot as d, normalizeCdpWsUrl as f, assertBrowserNavigationResultAllowed as g, assertBrowserNavigationAllowed as h, launchOpenClawChrome as i, resolveWritablePathWithinRoot as j, resolveExistingPathsWithinRoot as k, captureScreenshot as l, InvalidBrowserNavigationUrlError as m, isChromeCdpReady as n, stopOpenClawChrome as o, snapshotAria as p, isChromeReachable as r, resolveLsofCommandSync as s, getChromeWebSocketUrl as t, createTargetViaCdp as u, appendCdpPath as v, stopChromeExtensionRelayServer as w, getHeadersWithAuth as x, fetchJson as y, DEFAULT_OPENCLAW_BROWSER_COLOR as z };