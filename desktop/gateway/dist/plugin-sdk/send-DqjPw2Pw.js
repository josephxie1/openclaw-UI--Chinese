...
import { f as DEFAULT_ACCOUNT_ID, p as normalizeAccountId } from "./session-key-47BV2tLd.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-DCNrSyZW.js";
import { Kn as withFileLock$1, Qt as resolveTelegramPreviewStreamMode, i as readConfigFileSnapshotForWrite, n as loadConfig, o as writeConfigFile } from "./config-Zs384y2C.js";
import { $ as logVerbose, O as CONFIG_DIR, U as safeParseJson, Z as danger, t as createSubsystemLogger } from "./subsystem-D7KkLxSJ.js";
import { r as isTruthyEnvValue } from "./command-format-D4smYdZ1.js";
import { T as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-BixDCxgQ.js";
import { t as resolveFetch } from "./fetch-DH6qweqj.js";
import { t as redactSensitiveText } from "./redact-BYwaiynP.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-BMOVwRE7.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BMJujSSg.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-Y2wY7PYY.js";
import { n as normalizePollInput } from "./polls-Bqxnqm99.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-CCi2A8ff.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-DkTQOode.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-ojIJte73.js";
import { t as renderMarkdownWithMarkers } from "./render-BkW8s6LR.js";
import { t as makeProxyFetch } from "./proxy-B9hoooti.js";
...
async function readAllowFromStateForPathWithExists(channel, filePath) {
	...
	return {
		entries: normalizeAllowFromList(channel, value),
		exists
	};
}
...
function readAllowFromStateForPathSyncWithExists(channel, filePath) {
	...
	try {
		return {
			entries: normalizeAllowFromList(channel, JSON.parse(raw)),
			exists: true
		};
	} catch {
		return {
...
//#endregion
export { readChannelAllowFromStore as $, extractTelegramLocation as A, normalizeAllowFrom as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, parseTelegramTarget as G, resolveSenderAllowMatch as H, resolveTelegramReplyId as I, toLocationContext as J, resolveTelegramTargetChatType as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, addChannelAllowFromStoreEntry as Q, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, isVoiceCompatibleAudio as U, normalizeDmAllowFromWithStore as V, normalizeTelegramLookupTarget as W, isWSLEnv as X, isWSL2Sync as Y, isWSLSync as Z, resolveTelegramFetch as _, reactMessageTelegram as a, getPairingAdapter as at, buildGroupLabel as b, sendStickerTelegram as c, isSenderIdAllowed as ct, wasSentByBot as d, readChannelAllowFromStoreSync as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, writeJsonFileAtomically as it, hasBotMention as j, expandTextLinks as k, send_exports as l, mergeDmAllowFromSources as lt, markdownToTelegramHtml as m, createForumTopicTelegram as n, upsertChannelPairingRequest as nt, sendMessageTelegram as o, listPairingChannels as ot, markdownToTelegramChunks as p, formatLocationText as q, deleteMessageTelegram as r, readJsonFileWithFallback as rt, sendPollTelegram as s, firstDefined as st, buildInlineKeyboard as t, removeChannelAllowFromStoreEntry as tt, resolveTelegramVoiceSend as u, resolveGroupAllowFromSources as ut, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, isSenderAllowed as z };