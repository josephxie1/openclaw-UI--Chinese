...
import { L as colorize, N as setVerbose, R as isRich, b as shortenHomeInString, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-CfiuWRBq.js";
import { M as loadConfig, ct as parseDurationMs, hn as splitShellArgs } from "./auth-profiles-pmKds52w.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-DRzgjfKp.js";
import { t as formatDocsLink } from "./links-DYpENcXv.js";
import { r as withManager } from "./cli-utils-CzLjS-VZ.js";
import { t as formatHelpExamples } from "./help-format-BLXd9zgu.js";
import { n as withProgress, r as withProgressTotals } from "./progress-Be7vAY6t.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DXGf9BQb.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-GV8znJx7.js");
