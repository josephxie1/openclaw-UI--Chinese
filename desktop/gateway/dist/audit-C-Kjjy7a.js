import { g as resolveStateDir, m as resolveOAuthDir, o as resolveConfigPath } from "./paths-DPETYfXn.js";
import { C as formatPermissionRemediation, On as INCLUDE_KEY, S as formatPermissionDetail, T as safeStat, j as createConfigIO, kn as MAX_INCLUDE_DEPTH, ot as isDangerousNetworkMode, qt as normalizeTrustedSafeBinDirs, st as normalizeNetworkMode, w as inspectPathPermissions } from "./auth-profiles-pmKds52w.js";
import { t as formatCliCommand } from "./command-format-D-E6F1gN.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-CLHs7Zj4.js";
import { s as normalizeAgentId } from "./session-key-Bbgq13tJ.js";
import { i as isPathInside, n as MANIFEST_KEY, r as extensionUsesSkippedScannerPath } from "./legacy-names-C0r5T3Cj.js";
import { u as normalizePluginsConfig } from "./manifest-registry-NoROo1B_.js";
import { l as normalizeStringEntries } from "./dock-CMVWLgFK.js";
import { i as loadWorkspaceSkillEntries } from "./skills-BfREX8cQ.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-B603rVd0.js";
import { n as listChannelPlugins } from "./plugins-CD0OuhLK.js";
import { t as GatewayClient, zt as normalizeDeviceMetadataForPolicy } from "./client-DOO0IIji.js";
import { c as READ_SCOPE, t as buildGatewayConnectionDetails } from "./call-B9HMBIgs.js";
import { t as resolveGatewayCredentialsFromConfig } from "./credentials-C6mXW-Sw.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-Bq11A_Rx.js";
import { a as resolveGatewayAuth } from "./auth-BFLoV1Uy.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-wSt48nR2.js";
import { n as formatErrorMessage } from "./errors-PLZQFUCD.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-Gm0Ce4Eg.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-luj13TjG.js";
import { i as readChannelAllowFromStore } from "./pairing-store-BZczo3JC.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BD0uwmTh.js";
import { l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-S0d-FxBM.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-CSq9sJDG.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-DYZcWH6U.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-2OSlA4bi.js";
import { c as normalizeTelegramAllowFromEntry, s as isNumericTelegramUserId, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-COMtneie.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-Dir-zlOZ.js";
...
function isFeishuDocToolEnabled(cfg) {
	...
	for (const accountValue of Object.values(accounts)) {
		...
		if ((hasNonEmptyString(account.appId) || baseAppId) && (hasNonEmptyString(account.appSecret) || baseAppSecret)) return true;
	}
	return false;
}
...
async function runSecurityAudit(opts) {
	...
	if (opts.includeFilesystem !== false) {
		...
		findings.push(...await collectSandboxBrowserHashLabelFindings({ execDockerRawFn: opts.execDockerRawFn }));
...
//#endregion
export { isNodeCommandAllowed as a, resolveGatewayProbeAuth as i, collectEnabledInsecureOrDangerousFlags as n, resolveNodeCommandAllowlist as o, collectIncludePathsRecursive as r, probeGateway as s, runSecurityAudit as t };