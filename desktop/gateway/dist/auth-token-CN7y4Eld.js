...
import { Ar as VENICE_BASE_URL, Br as buildSyntheticModelDefinition, Cr as buildQianfanProvider, Fn as upsertAuthProfile, Fr as TOGETHER_MODEL_CATALOG, Gn as resolveOpenClawAgentDir, Ir as buildTogetherModelDefinition, Lr as SYNTHETIC_BASE_URL, Mr as VENICE_MODEL_CATALOG, Nr as buildVeniceModelDefinition, Pr as TOGETHER_BASE_URL, Rr as SYNTHETIC_DEFAULT_MODEL_REF, Sr as buildKimiCodingProvider, br as XIAOMI_DEFAULT_MODEL_ID, ci as buildCloudflareAiGatewayModelDefinition, di as normalizeSecretInput, fi as KILOCODE_BASE_URL, hi as coerceSecretRef, ii as buildHuggingfaceModelDefinition, jr as VENICE_DEFAULT_MODEL_REF, li as resolveCloudflareAiGatewayBaseUrl, mi as DEFAULT_SECRET_PROVIDER_ALIAS, ni as HUGGINGFACE_BASE_URL, or as normalizeProviderId, pi as KILOCODE_DEFAULT_MODEL_REF, ri as HUGGINGFACE_MODEL_CATALOG, si as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, vr as QIANFAN_BASE_URL, wr as buildXiaomiProvider, xr as buildKilocodeProvider, yr as QIANFAN_DEFAULT_MODEL_ID, zr as SYNTHETIC_MODEL_CATALOG } from "./auth-profiles-CZvcgpJo.js";
...
function applyMinimaxConfig(cfg) {
	return applyAgentDefaultModelPrimary(applyMinimaxProviderConfig(cfg), "lmstudio/minimax-m2.1-gs32");
}
