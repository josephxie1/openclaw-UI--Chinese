import { g as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-DPETYfXn.js";
import { B as createInternalHookEvent, D as getActivePluginRegistry, H as triggerInternalHook, V as registerInternalHook, a as setConsoleSubsystemFilter, j as createEmptyPluginRegistry, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger, v as CHANNEL_IDS, z as clearInternalHooks } from "./subsystem-Cg_UWVEG.js";
import { B as getChildLogger, E as isPlainObject, H as getResolvedLoggerSettings, L as colorize, N as setVerbose, R as isRich, T as truncateUtf16Safe, V as getLogger, j as logVerbose, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath, z as theme } from "./utils-CfiuWRBq.js";
import "./boolean-YY6K2DFz.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { Ai as DEFAULT_MODEL, An as buildTalkConfigResponse, Dr as resolveThinkingDefault, Dt as isAvatarHttpUrl, F as readConfigFileSnapshotForWrite, H as validateConfigObjectWithPlugins, I as resolveConfigSnapshotHash, M as loadConfig, Mn as resolveAgentMaxConcurrent, Mt as looksLikeAvatarPath, N as parseConfigJson5, Nn as resolveSubagentMaxConcurrent, O as migrateLegacyConfig, Ot as isAvatarImageDataUrl, P as readConfigFileSnapshot, R as writeConfigFile, Sr as resolveHooksGmailModel, Tr as resolveSubagentConfiguredModelSelection, Tt as AVATAR_MAX_BYTES$1, U as OpenClawSchema, ar as isPidAlive, bn as applyLegacyMigrations, br as resolveConfiguredModelRef, ct as parseDurationMs, fr as isCliProvider, hr as normalizeModelSelection, j as createConfigIO, ji as DEFAULT_PROVIDER, ki as DEFAULT_CONTEXT_TOKENS, lt as parseByteSize, or as buildAllowedModelSet, ur as getModelRefStatus, vr as resolveAllowedModelRef, xi as normalizeSecretInput, xn as ensureControlUiAllowedOriginsForNonLoopbackBind, xr as resolveDefaultModelForAgent, yn as applyMergePatch } from "./auth-profiles-BghqkBM8.js";
import { t as formatCliCommand } from "./command-format-D-E6F1gN.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-CIzpI5xh.js";
import { C as isSubagentSessionKey, c as normalizeMainKey, f as toAgentRequestSessionKey, h as normalizeAccountId$1, l as resolveAgentIdFromSessionKey, m as DEFAULT_ACCOUNT_ID, o as classifySessionKeyShape, p as toAgentStoreSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-Bbgq13tJ.js";
import { a as openBoundaryFileSync, f as isNotFoundPathError, h as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-3Za7U6qY.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-BAZSkTa2.js";
import "./github-copilot-token-BBzjUbRV.js";
import "./host-env-security-DWcSD4kP.js";
import { a as resolveRuntimeServiceVersion, t as VERSION } from "./version-Bed7ywW_.js";
import "./env-vars-UJroIeWA.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-CzxIZ7xJ.js";
...
import { d as hasBinary } from "./frontmatter-CmZFrduY.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-Cc0j4M1-.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-CQioIZOJ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dl_mVGTt.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-B603rVd0.js";
import { A as archiveFileOnDisk, E as mergeDeliveryContext, F as readSessionPreviewItemsFromTranscript, G as cleanStaleLockFiles, H as stripInlineDirectiveTagsFromMessageForDisplay, L as resolveSessionTranscriptCandidates, M as capArrayByJsonBytes, N as cleanupArchivedSessionTranscripts, O as normalizeSessionDeliveryFields, P as readSessionMessages, R as stripEnvelopeFromMessage, U as jsonUtf8Bytes, V as stripInlineDirectiveTagsForDisplay, Z as evaluateSessionFreshness, bt as snapshotSessionOrigin, ct as mergeSessionEntry, dt as setSessionRuntimeModel, ft as canonicalizeMainSessionAlias, gt as resolveMainSessionKeyFromConfig, ht as resolveMainSessionKey, j as archiveSessionTranscripts, mt as resolveExplicitAgentSessionKey, n as parseSessionThreadInfo, pt as resolveAgentMainSessionKey, t as extractDeliveryInfo, tt as resolveSessionResetPolicy, u as loadSessionStore, v as updateSessionStore, w as deliveryContextFromSession, z as stripEnvelopeFromMessages } from "./sessions-DVvS5iwr.js";
import { _ as normalizeWhatsAppTarget, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Bxiq3d8j.js";
...
import { t as buildChannelAccountBindings } from "./bindings-DcmrAriy.js";
import "./send-C-ZtfR2_.js";
import "./send-CPy55VXG.js";
import { $n as DEFAULT_INPUT_TIMEOUT_MS, $t as buildDeliveryFromLegacyPayload, An as loadProviderUsageSummary, Ar as getActiveTaskCount, At as resolveOutboundChannelPlugin, B as resolveAgentOutboundTarget, Bn as enqueueSystemEvent, Bt as summarizeRestartSentinel, Cn as scheduleGatewaySigusr1Restart, Cr as resolveTtsPrefsPath, D as loadOpenClawPlugins, Dn as unbindThreadBindingsBySessionKey, Dr as textToSpeech, En as triggerOpenClawRestart, Er as setTtsProvider, F as sleepWithAbort, Fn as formatZonedTimestamp, Fr as setCommandLaneConcurrency, Gr as getAgentRunContext, Gt as normalizeCronJobPatch, H as createDefaultDeps, Hr as stripHeartbeatToken, Ht as writeRestartSentinel, Ir as waitForActiveTasks, It as consumeRestartSentinel, Jt as normalizeOptionalSessionKey, Kr as onAgentEvent, Kt as inferLegacyName, L as agentCommand, Lr as CommandLane, Lt as formatDoctorNonInteractiveHint, M as readJsonBodyWithLimit, Mr as getTotalQueueSize, Mt as resetDirectoryCache, N as requestBodyErrorToText, Nr as markGatewayDraining, On as normalizeGroupActivation, Or as OPENAI_TTS_MODELS, Ot as resolveOutboundTarget, P as computeBackoff, Pr as resetAllLanes, Pt as runWithModelFallback, Qn as DEFAULT_INPUT_MAX_REDIRECTS, Qt as migrateLegacyCronPayload, Rr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Rt as formatRestartSentinelMessage, S as buildDefaultToolPolicyPipelineSteps, Sn as markGatewaySigusr1RestartHandled, Sr as resolveTtsConfig, St as resolveAnnounceTargetFromKey, T as resolvePluginTools, Tn as setPreRestartDeferralCheck, Tr as setTtsEnabled, Tt as resolveOutboundSessionRoute, U as createOutboundSendDeps$1, Ur as clearAgentRunContext, Ut as normalizeHttpWebhookUrl, V as createOutboundSendDeps, Vn as isSystemEventContextChanged, W as resolveAgentAvatar, Wn as requestHeartbeatNow, Wr as emitAgentEvent, Wt as normalizeCronJobCreate, Xn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Xt as normalizePayloadToSystemText, Yn as ACP_SESSION_IDENTITY_RENDERER_VERSION, Yt as normalizeOptionalText, Z as buildHistoryContextFromEntries, Zn as DEFAULT_INPUT_IMAGE_MIMES, Zt as normalizeRequiredName, _ as runEmbeddedPiAgent, _n as buildOutboundSessionContext, _r as getTtsProvider, _t as getCliSessionId, an as detectSuspiciousPatterns, ar as normalizeSendPolicy, b as waitForEmbeddedPiRunEnd, bn as emitGatewayRestart, br as resolveTtsApiKey, bt as createOpenClawTools, c as listDescendantRunsForRequester, cn as applyBrowserProxyPaths, dt as getTotalPendingReplies, en as hasLegacyDeliveryHints, er as extractFileContentFromSource, g as clearSessionQueues, gn as parseVerboseOverride, gr as clearBootstrapSnapshot, gt as resolveCronStyleNow, h as runSubagentAnnounceFlow, hn as applyVerboseOverride, hr as resolveUserTimezone, in as buildSafeExternalPrompt, ir as resolveAgentTimeoutMs, j as handleSlackHttpRequest, k as resolveAgentOutboundIdentity, kr as OPENAI_TTS_VOICES, kt as resolveSessionDeliveryTarget, ln as persistBrowserProxyFiles, lr as isAbortRequestText, lt as dispatchInboundMessage, mn as applyModelOverrideToSessionEntry, mr as resolveAgentSessionDirs, mt as BARE_SESSION_RESET_PROMPT, n as countActiveDescendantRuns, nr as normalizeMimeList, o as initSubagentRegistry, on as getHookType, or as resolveSendPolicy, pr as getAcpSessionManager, qr as registerAgentRunContext, qt as normalizeOptionalAgentId, rr as resolveInputFileLimits, sn as isExternalHookSession, tn as stripLegacyDeliveryFields, tr as extractImageContentFromSource, un as resolveSessionAuthProfileOverride, ur as stopSubagentsForRequester, ut as createReplyDispatcher, v as abortEmbeddedPiRun, vn as consumeGatewaySigusr1RestartAuthorization, vr as isTtsEnabled, vt as setCliSessionId, w as getPluginToolMeta, wn as setGatewaySigusr1RestartPolicy, wr as resolveTtsProviderOrder, wt as ensureOutboundSessionEntry, x as applyToolPolicyPipeline, xn as isGatewaySigusr1RestartExternallyAllowed, xr as resolveTtsAutoMode, xt as readLatestAssistantReply, y as getActiveEmbeddedRunCount, yn as deferGatewayRestartUntilIdle, yr as isTtsProviderConfigured, yt as runCliAgent, z as resolveAgentDeliveryPlan } from "./subagent-registry-BYIe-M9p.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CVD1Nvmu.js";
import { i as normalizeInputProvenance } from "./input-provenance-BpaGxV1q.js";
import "./chat-envelope-BzTdl9Cm.js";
import { $ as validateNodePairListParams, A as validateCronRunsParams, At as validateWizardStatusParams, B as validateExecApprovalResolveParams, Bt as approveDevicePairing, C as validateConfigSchemaParams, Ct as validateUpdateRunParams, D as validateCronListParams, Dt as validateWizardCancelParams, E as validateCronAddParams, Et as validateWebLoginWaitParams, F as validateDevicePairRejectParams, Ft as parseSessionLabel, G as validateLogsTailParams, Gt as removePairedDevice, H as validateExecApprovalsNodeGetParams, Ht as getPairedDevice, I as validateDevicePairRemoveParams, It as buildDeviceAuthPayload, J as validateNodeEventParams, Jt as rotateDeviceToken, K as validateModelsListParams, Kt as requestDevicePairing, L as validateDeviceTokenRevokeParams, Lt as buildDeviceAuthPayloadV3, M as validateCronUpdateParams, Mt as ErrorCodes, N as validateDevicePairApproveParams, Nt as errorShape, O as validateCronRemoveParams, Ot as validateWizardNextParams, P as validateDevicePairListParams, Q as validateNodePairApproveParams, Qt as roleScopesAllow, R as validateDeviceTokenRotateParams, Rt as normalizeDeviceMetadataForAuth, S as validateConfigRawParams, St as validateToolsCatalogParams, T as validateConnectParams, Tt as validateWebLoginStartParams, U as validateExecApprovalsNodeSetParams, Ut as listDevicePairing, V as validateExecApprovalsGetParams, Vt as ensureDeviceToken, W as validateExecApprovalsSetParams, Wt as rejectDevicePairing, X as validateNodeInvokeResultParams, Xt as updatePairedDeviceMetadata, Y as validateNodeInvokeParams, Yt as summarizeDeviceTokens, Z as validateNodeListParams, Zt as verifyDeviceToken, _ as validateChatInjectParams, _t as validateSkillsInstallParams, a as validateAgentWaitParams, at as validatePushTestParams, b as validateConfigGetParams, bt as validateTalkConfigParams, c as validateAgentsFilesGetParams, ct as validateSessionsCompactParams, d as validateAgentsListParams, dt as validateSessionsPatchParams, en as deriveDeviceIdFromPublicKey, et as validateNodePairRejectParams, f as validateAgentsUpdateParams, ft as validateSessionsPreviewParams, g as validateChatHistoryParams, gt as validateSkillsBinsParams, h as validateChatAbortParams, ht as validateSessionsUsageParams, i as validateAgentParams, it as validatePollParams, j as validateCronStatusParams, jt as PROTOCOL_VERSION, k as validateCronRunParams, kt as validateWizardStartParams, l as validateAgentsFilesListParams, lt as validateSessionsDeleteParams, m as validateChannelsStatusParams, mt as validateSessionsResolveParams, n as formatValidationErrors, nn as normalizeDevicePublicKeyBase64Url, nt as validateNodePairVerifyParams, o as validateAgentsCreateParams, ot as validateRequestFrame, p as validateChannelsLogoutParams, pt as validateSessionsResetParams, q as validateNodeDescribeParams, qt as revokeDeviceToken, r as validateAgentIdentityParams, rn as verifyDeviceSignature, rt as validateNodeRenameParams, s as validateAgentsDeleteParams, st as validateSendParams, tt as validateNodePairRequestParams, u as validateAgentsFilesSetParams, ut as validateSessionsListParams, v as validateChatSendParams, vt as validateSkillsStatusParams, w as validateConfigSetParams, wt as validateWakeParams, x as validateConfigPatchParams, xt as validateTalkModeParams, y as validateConfigApplyParams, yt as validateSkillsUpdateParams, z as validateExecApprovalRequestParams } from "./client-3f8mxJEH.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-BMs9hz0g.js";
import { c as readJsonFile, l as writeJsonAtomic, s as createAsyncLock } from "./pairing-token-DvOER2xR.js";
import { t as safeEqualSecret } from "./secret-equal-B1fn_K9H.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-D_wo0Sl1.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-67wWyYBV.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-BNWBl2Xc.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-wJ3IPPQ4.js";
import { C as runGlobalGatewayStopSafely, a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, x as getGlobalHookRunner } from "./deliver-Dy8zt_KL.js";
import { g as isDiagnosticsEnabled, m as stopDiagnosticHeartbeat, p as startDiagnosticHeartbeat } from "./diagnostic-DHd2HQ8l.js";
import { r as pruneDiagnosticSessionStates, t as diagnosticSessionStates } from "./diagnostic-session-state-z4ityqlG.js";
import { d as resolveCronStorePath, f as saveCronStore, u as loadCronStore } from "./send-9G2_iyeT.js";
import { c as detectMime } from "./image-ops-2_ZDkf3K.js";
import "./pi-embedded-helpers-Of3qHWQl.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DTxaN4ta.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-4hvNhN9N.js";
import "./chrome-vkPv6Hbo.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DYJAYqJb.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-DhIxsXk7.js";
import { l as ensureGatewayStartupAuth, u as mergeGatewayTailscaleConfig } from "./server-context-CTOIotCF.js";
import "./paths-CjKUISLf.js";
import { i as compileSafeRegex } from "./redact-CcVV4RYD.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-PLZQFUCD.js";
import { a as readLocalFileSafely, o as writeFileWithinRoot, r as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-BuWUIX7Q.js";
import { t as SsrFBlockedError } from "./ssrf-CWEIH4LI.js";
import "./store-BBLlgREE.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-B6VfKv4T.js";
import { t as movePathToTrash } from "./trash-Byfl_5o-.js";
import "./server-middleware-CO3jp0WE.js";
import "./tool-images-DW9VWMTP.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BCY5R30D.js";
...
import { a as resolveAgentIdentity, n as createReplyPrefixOptions } from "./reply-prefix-CYtxVhuE.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-D_gNNCvC.js";
import { n as resolveMemorySearchConfig } from "./manager-CkKrVtnJ.js";
import "./gemini-auth-CcQR8bbq.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BKF2fXF6.js";
import "./query-expansion-Bg0At0ZP.js";
import "./retry-CAPGTG0m.js";
import { a as ToolInputError } from "./target-errors-DSKF3qi3.js";
...
import { r as isRestartEnabled } from "./commands-Caw9RrEA.js";
import "./commands-registry-BD9m-_KG.js";
import { x as extractTextFromChatContent } from "./image-DVKsEJXY.js";
import "./tool-display-BQX7EkN8.js";
import { r as getChannelActivity } from "./retry-policy-DiZBRfGT.js";
import { d as registerUnhandledRejectionHandler } from "./runner-D3x4dI-S.js";
import { n as loadModelCatalog } from "./model-catalog-CW4skMS-.js";
import "./fetch-DAjuWoh7.js";
import { a as readChannelAllowFromStoreSync, d as listPairingChannels, f as notifyPairingApproved, n as approveChannelPairingCode, r as listChannelPairingRequests } from "./pairing-store-YH2HFXvC.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-BkOVifzQ.js";
import { _ as matchSystemRunApprovalBinding, g as buildSystemRunApprovalBinding, h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext, v as missingSystemRunApprovalBinding, y as toSystemRunApprovalMismatchError } from "./nodes-screen-C6N15x3L.js";
import { n as resolveSystemRunCommand } from "./system-run-command-CKlRxQlI.js";
...
import { a as loadSessionUsageTimeSeries, c as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-CfwWloSB.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BxjB8vcE.js";
import { _ as updatePairedNodeMetadata, a as getRemoteSkillEligibility, b as getSkillsSnapshotVersion, c as refreshRemoteBinsForConnectedNodes, d as setSkillsRemoteRegistry, f as approveNodePairing, g as requestNodePairing, h as renamePairedNode, l as refreshRemoteNodeBins, m as rejectNodePairing, o as primeRemoteSkillsCache, p as listNodePairing, s as recordRemoteNodeInfo, u as removeRemoteNodeInfo, v as verifyNodeToken, x as registerSkillsChangeListener } from "./skill-commands-DhHBQLqc.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BaVg8nWH.js";
import { n as normalizePollInput } from "./polls-DgoQTHbK.js";
import "./tables-Dqs_W3wZ.js";
import "./server-lifecycle-CpMS9ycF.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BIZMWR_z.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-PjBtbF3C.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Cy87bL7f.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-h94KMUAM.js";
...
import { t as formatHelpExamples } from "./help-format-BLXd9zgu.js";
import { n as withProgress } from "./progress-Be7vAY6t.js";
import "./replies-Csknt1mL.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-IFNeulFC.js";
import "./prompt-style-D01Z207U.js";
import "./pairing-labels-yDRvsz-L.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CYatxg74.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D9b06oqv.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DHM738Xi.js";
import { n as inheritOptionFromParent } from "./command-options-WgwfsgBg.js";
import { t as WizardCancelledError } from "./prompts-BkPGYLNt.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-XEVtoWU2.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D0p9s3oQ.js";
import { t as isWithinDir } from "./path-safety-C_fs8VTy.js";
import "./install-safe-path-fH49zDtC.js";
import "./skill-scanner--ApPM6CU.js";
import { t as buildChannelAccountSnapshot } from "./status-ZYMph4rn.js";
import "./channels-status-issues-CCkvxSvf.js";
import { a as restoreRedactedValues, c as mapSensitivePaths, i as redactConfigSnapshot, l as applyDerivedTags, n as redactConfigObject, o as applySensitiveHints, s as buildBaseHints } from "./redact-snapshot-CWPk9bz6.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-CeWXfkg6.js";
import "./diagnostics-Ca1e5iIs.js";
import "./table-D_8bv6eo.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CbRdwx4v.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-ENYad1pQ.js";
import { a as isNodeCommandAllowed, n as collectEnabledInsecureOrDangerousFlags, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-CFlVD0sj.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-_YNuTfyi.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-hr2BnyEC.js";
import { c as startHeartbeatRunner, i as styleHealthChannelLine, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-Cgxhr072.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-GGFclzNd.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CpsEsWss.js";
import { i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CN6kPlWo.js";
import { t as runOnboardingWizard } from "./onboarding-D4MZUjVz.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BKgmX3xD.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-GzJd4GO1.js";
import "./node-service-Dxv1gmP_.js";
import "./status.update-C70oszTJ.js";
import { t as installSkill } from "./skills-install-AjSeihrB.js";
import { t as runGatewayUpdate } from "./update-runner-Dy_mqC_R.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DvWHoa5S.js";
import { n as forceFreePortAndWait } from "./ports-BQCGRm6Z.js";
...
const configHandlers = {
	...
	"config.raw": async ({ params, respond }) => {
		...
		try {
			...
			if (parseResult.ok) {
				const { redactConfigRaw: doRedact } = await import("./redact-snapshot-dmoRBh91.js");
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DsSJT_Gt.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BRpOTX9T.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-vetuHYya.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DpqQ4bYo.js");
		const { deliverOutboundPayloads } = await import("./deliver-EABLWnUE.js");
