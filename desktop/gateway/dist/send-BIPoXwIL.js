import { _ as expandHomePrefix } from "./paths-BafI8hAX.js";
import { M as logVerbose, O as danger, t as CONFIG_DIR } from "./utils-C2rp27T1.js";
import { t as createSubsystemLogger } from "./subsystem-DoASNpMz.js";
import { h as normalizeAccountId } from "./session-key-B9ePuoPx.js";
import { Gt as readConfigFileSnapshotForWrite, Ht as loadConfig, Jt as writeConfigFile, Lr as resolveTelegramPreviewStreamMode } from "./model-selection-Byqz32hU.js";
import { t as isTruthyEnvValue } from "./env-DT45e_cy.js";
import { n as redactSensitiveText } from "./redact-DkGdi7vy.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-BRgSJZKa.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-BwGmDpam.js";
import { c as resolveTelegramAccount } from "./plugins-f8FOOJGM.js";
...
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-CuwuI9Dp.js";
import { t as renderMarkdownWithMarkers } from "./render-Dq7Qk4fS.js";
import { i as recordChannelActivity, n as createTelegramRetryRunner } from "./retry-policy-CRErIuSy.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-jwoWXqy7.js";
import { n as isWSL2Sync } from "./wsl-7ct9ThFI.js";
...
//#endregion
export { describeReplyTarget as A, resolveTelegramThreadSpec as B, buildSenderLabel as C, buildTelegramParentPeer as D, buildTelegramGroupPeerId as E, resolveTelegramForumThreadId as F, formatLocationText as G, normalizeAllowFrom as H, resolveTelegramGroupAllowFromContext as I, parseTelegramTarget as J, toLocationContext as K, resolveTelegramMediaPlaceholder as L, extractTelegramLocation as M, hasBotMention as N, buildTelegramThreadParams as O, normalizeForwardedContext as P, resolveTelegramReplyId as R, buildGroupLabel as S, buildTelegramGroupFrom as T, normalizeDmAllowFromWithStore as U, isSenderAllowed as V, resolveSenderAllowMatch as W, resolveTelegramTargetChatType as Y, renderTelegramHtmlText as _, reactMessageTelegram as a, splitTelegramCaption as b, sendStickerTelegram as c, resolveCronStorePath as d, saveCronStore as f, markdownToTelegramHtml as g, markdownToTelegramChunks as h, editMessageTelegram as i, expandTextLinks as j, buildTypingThreadParams as k, resolveTelegramVoiceSend as l, isRecoverableTelegramNetworkError as m, createForumTopicTelegram as n, sendMessageTelegram as o, wasSentByBot as p, isVoiceCompatibleAudio as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, loadCronStore as u, wrapFileReferencesInHtml as v, buildSenderName as w, withTelegramApiErrorLogging as x, resolveTelegramFetch as y, resolveTelegramStreamMode as z };