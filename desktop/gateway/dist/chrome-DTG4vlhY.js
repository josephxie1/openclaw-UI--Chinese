import { H as isPathInside, V as isNotFoundPathError } from "./agent-scope-2WLEGCGu.js";
import { T as CONFIG_DIR, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-BOPdQ1OK.js";
import { dt as isPrivateOrLoopbackIpAddress, ft as normalizeIpAddress, ut as isLoopbackIpAddress, z as loadConfig } from "./model-selection-ByiezZu1.js";
import { i as isErrno } from "./errors-gzROynDW.js";
import { r as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-BWMsSlDu.js";
import { a as resolvePinnedHostnameWithPolicy } from "./ssrf-w8ZK882q.js";
...
async function withNoProxyForLocalhost(fn) {
	if (!hasProxyEnv()) return fn();
...
async function fetchChecked(url, timeoutMs = 1500, init) {
	...
	try {
		...
		const res = await withNoProxyForLocalhost(() => fetch(url, {
			...init,
			headers,
			signal: ctrl.signal
		}));
...
async function fetchChromeVersion(cdpUrl, timeoutMs = 500) {
	...
	try {
		...
		const res = await withNoProxyForLocalhost(() => fetch(versionUrl, {
			signal: ctrl.signal,
...
//#endregion
export { resolveExistingPathsWithinRoot as A, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as B, ensureChromeExtensionRelayServer as C, DEFAULT_DOWNLOAD_DIR as D, rawDataToString as E, isLoopbackHost as F, DEFAULT_OPENCLAW_BROWSER_COLOR as H, isSecureWebSocketUrl as I, DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH as L, resolveWritablePathWithinRoot as M, DEFAULT_FILL_FIELD_TYPE as N, DEFAULT_TRACE_DIR as O, normalizeBrowserFormField as P, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as R, withCdpSocket as S, withNoProxyForLocalhost as T, DEFAULT_OPENCLAW_BROWSER_ENABLED as U, DEFAULT_BROWSER_EVALUATE_ENABLED as V, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as W, withBrowserNavigationPolicy as _, resolveOpenClawUserDataDir as a, fetchOk as b, resolveBrowserExecutableForPlatform as c, formatAriaSnapshot as d, normalizeCdpWsUrl as f, assertBrowserNavigationResultAllowed as g, assertBrowserNavigationAllowed as h, launchOpenClawChrome as i, resolveStrictExistingPathsWithinRoot as j, DEFAULT_UPLOAD_DIR as k, captureScreenshot as l, InvalidBrowserNavigationUrlError as m, isChromeCdpReady as n, stopOpenClawChrome as o, snapshotAria as p, isChromeReachable as r, resolveLsofCommandSync as s, getChromeWebSocketUrl as t, createTargetViaCdp as u, appendCdpPath as v, stopChromeExtensionRelayServer as w, getHeadersWithAuth as x, fetchJson as y, DEFAULT_AI_SNAPSHOT_MAX_CHARS as z };