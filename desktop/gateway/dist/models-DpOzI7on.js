...
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-CIzpI5xh.js";
import { r as resolveForwardCompatModel } from "./model-DQUJaG-0.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BGDavJtN.js";
import { An as loadProviderUsageSummary, Ft as describeFailoverError, Mn as formatUsageWindowSummary, Nn as resolveUsageProviderId, Pn as maskApiKey, _ as runEmbeddedPiAgent, dn as DEFAULT_OAUTH_WARN_MS, fn as buildAuthHealthSummary, pn as formatRemainingShort } from "./subagent-registry-BYIe-M9p.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CVD1Nvmu.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BEtR6mBz.js";
import { n as loadModelCatalog } from "./model-catalog-CW4skMS-.js";
import { r as withProgressTotals } from "./progress-Be7vAY6t.js";
import { d as openUrl } from "./onboard-helpers-IFNeulFC.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DyzXWCkV.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CLLJAWJB.js";
import { n as logConfigUpdated } from "./logging-DS0Tn5Cy.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-9DuMhMcn.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-B9-ztXqa.js");
	const { ensureAuthProfileStore } = await import("./auth-profiles-P05gIIhm.js");
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-zO7CIjmz.js");
