import { Cr as unwrapKnownDispatchWrapperInvocation, Er as SAFE_BIN_PROFILES, _r as extractShellWrapperInlineCommand, br as isShellWrapperExecutable, cr as isWindowsPlatform, dr as DEFAULT_SAFE_BINS, fr as matchAllowlist, ir as validateSafeBinArgv, mr as resolveCommandResolutionFromArgv, or as analyzeShellCommand, pr as resolveAllowlistCandidatePath, tr as isTrustedSafeBinPath, ur as splitCommandChain, wr as unwrapKnownShellMultiplexerInvocation, yr as isDispatchWrapperExecutable } from "./model-selection-Byqz32hU.js";
	...
	if (shellMultiplexerUnwrap.kind === "unwrapped") {
		collectAllowAlwaysPatterns({
			segment: {
				...
				resolution: resolveCommandResolutionFromArgv(shellMultiplexerUnwrap.argv, params.cwd, params.env)
			},
			cwd: params.cwd,
			env: params.env,
			platform: params.platform,
