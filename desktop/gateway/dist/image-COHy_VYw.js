...
import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-CyL4p3WM.js";
import { M as isRecord, V as shortenHomeInString } from "./subsystem-mPRezpll.js";
import { B as loadConfig, D as requireApiKey, En as resolveOpenClawAgentDir, Mn as normalizeSecretInput, T as getApiKeyForModel, _ as normalizeProviders, b as resolveImplicitProviders, v as resolveImplicitBedrockProvider, y as resolveImplicitCopilotProvider } from "./model-selection-C2qYg1Hy.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DA6plQNR.js";
import { F as sanitizeUserFacingText } from "./pi-embedded-helpers-IaWApo7A.js";
import { n as redactToolDetail } from "./redact-B5RjPWCN.js";
	...
	tools: {
		...
		"lobster": {
			...
			"actions": {
				"run": {
					"label": "run",
					"detailKeys": ["pipeline", "timeoutMs"]
				},
				"resume": {
					"label": "resume",
					"detailKeys": ["token", "approve"]
				}
			}
		},
		"llm-task": {
...
function formatToolDetail(display) {
	return formatToolDetailText(display.detail ? redactToolDetail(display.detail) : void 0, { prefixWithWith: true });
}
...
//#endregion
export { isInsideCode as C, findCodeRegions as S, ensureOpenClawModelsJson as T, stripMinimaxToolCallXml as _, decodeDataUrl as a, resolveToolDisplay as b, extractAssistantText as c, extractThinkingFromTaggedText as d, formatReasoningMessage as f, stripDowngradedToolCallText as g, promoteThinkingTagsToBlocks as h, coerceImageModelConfig as i, extractAssistantThinking as l, isAssistantMessage as m, image_exports as n, resolveProviderVisionModelFromConfig as o, inferToolMetaFromArgs as p, coerceImageAssistantText as r, minimaxUnderstandImage as s, describeImageWithModel as t, extractThinkingFromTaggedStream as u, stripThinkingTagsFromText as v, extractTextFromChatContent as w, stripReasoningTagsFromText as x, formatToolSummary as y };