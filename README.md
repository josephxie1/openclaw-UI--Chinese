...
| 概览 + 2D 牧场场景                         | 聊天界面（思考过程 + 工具调用）              |
| ------------------------------------------ | ------------------------------------------ |
| ![概览牧场](assets/overview-ranch.png)      | ![聊天界面](assets/chat-tools.png)          |

| 配置页面（全中文 Schema）                   | Agent 设置 + 侧栏配置                      |
| ------------------------------------------ | ------------------------------------------ |
| ![配置页面](assets/config-schema.png)       | ![Agent设置](assets/agent-settings.png)     |

| 频道管理 + 快速添加                         | 概览下半部分（图表 + Agent 卡片）            |
| ------------------------------------------ | ------------------------------------------ |
| ![频道管理](assets/channel-quickadd.png)    | ![Agent卡片](assets/overview-cards.png)     |

### 🚀 启动 & 配置引导

| 启动画面                 | 欢迎向导                 |
| ------------------------ | ------------------------ |
| ![启动画面](docs/01.png) | ![欢迎向导](docs/02.png) |

| 选择模型提供商                 | 配置 API Key                 |
| ------------------------------ | ---------------------------- |
| ![选择模型提供商](docs/03.png) | ![配置 API Key](docs/04.png) |

| 添加消息渠道                 | 配置完成                 |
| ---------------------------- | ------------------------ |
| ![添加消息渠道](docs/05.png) | ![配置完成](docs/06.png) |

### 💬 聊天 & 主界面

| 全量中文界面                       | 概览页面                       |
| ---------------------------------- | ------------------------------ |
| ![全量中文界面](docs/全量汉化.png) | ![概览页面](docs/概览页面.png) |

| Markdown 代码高亮                                   | 工具调用优化                               |
| --------------------------------------------------- | ------------------------------------------ |
| ![Markdown 代码高亮](docs/增加markdown代码显示.png) | ![工具调用优化](docs/工具调用显示优化.png) |

### ⚙️ 配置管理

| 模型配置页面                           | 频道快速配置                           |
| -------------------------------------- | -------------------------------------- |
| ![模型配置页面](docs/模型配置页面.png) | ![频道快速配置](docs/频道快速配置.png) |

| 配置文件编辑                               | 频道可视化审批                             |
| ------------------------------------------ | ------------------------------------------ |
| ![配置文件编辑](docs/配置文件快速编辑.png) | ![频道可视化审批](docs/频道可视化审批.png) |
